...
## Corpus Check
- 274 files · ~167,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2360 nodes · 3620 edges · 170 communities (158 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d890c88a`
...
Cohesion: 0.09
Nodes (22): feature, root, feature, root, createAkkordUebersichtFeature(), feature, root, root (+14 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (31): addRecording(), buildFileName(), buildSidecarJson(), clearRecordings(), dbClear(), dbDelete(), dbGetAll(), dbPut() (+23 more)
...
Cohesion: 0.13
Nodes (20): buildBassNeighborScores(), buildBassSupportByChord(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS, evaluateBassSupportForChord(), findPeakLinearMagnitudeNearFrequency(), FUNDAMENTAL_HARMONICS, FUNDAMENTAL_WEIGHTS (+12 more)
...
Cohesion: 0.12
Nodes (19): consumeOnsetGate(), createOnsetGateState(), isOnsetGateOpen(), updateOnsetGate(), countRmsOnsets(), replay, res, result (+11 more)
...
Cohesion: 0.12
Nodes (17): buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets(), discoverSheetMusicSequenceFixtures(), evaluateFixture(), formatAlignmentIssueCase(), formatAlignmentSummaryCase(), formatMs() (+9 more)
...
Cohesion: 0.15
Nodes (17): ANALYSER_GOLDENS_DIR, evaluateOpenStringNoteFingerprint(), evaluateOpenStringNoteFingerprintForStrategy(), evaluateSingleNoteOnsetFixture(), FIXTURES_DIR, formatOpenStringNoteFingerprintReport(), formatPercent(), loadAnalyserGolden() (+9 more)
...
Cohesion: 0.12
Nodes (17): matchEssentiaFingerprintHpcpToChord(), ALL_CHORD_NAMES, ALL_TEMPLATES, __dirname, NON_STRICT_MATRIX_CASES, POSITIVE_PREPARED_FIXTURES, PREPARED_FIXTURES, result (+9 more)
...
Cohesion: 0.15
Nodes (15): createAkkordfolgenAudioSession(), createBeatChordSync(), generateRandomProgression(), MAJOR_KEYS, PROGRESSIONS, ROMAN_NUMERALS, createAkkordfolgenTrainerFeature(), resolveAkkordfolgenUI() (+7 more)
...
Cohesion: 0.15
Nodes (14): computeActiveBandRatio(), computeBroadbandFlux(), dbToLinear(), toLinearMagnitudes(), updateGuitarOnsetDetector(), computeFrameRms(), computeFrameRms(), mixedSpectrum() (+6 more)
...
Cohesion: 0.11
Nodes (18): averageHpcps(), toAverageHpcp(), avgHpcp, bassBlockedFPs, bassCriticalTPs, bidirectionalPairs, __dirname, fpKeys (+10 more)

### Community 42 - "Community 42"
Cohesion: 0.16
Nodes (14): evaluateAnswer(), initGameState(), syncSheetMusicUI(), draws, pos, previous, result, settings (+6 more)
...
Cohesion: 0.15
Nodes (13): feature, root, createAkkordTrainerFeature(), btnUpdate, debugStore, initSettings(), menuView, forceAppReload() (+5 more)

### Community 48 - "Community 48"
Cohesion: 0.18
Nodes (13): closeAkkordfolgenAudioSession(), openAkkordfolgenAudioSession(), closeAudioSession(), createAudioSessionState(), openAudioSession(), stopMicrophoneStream(), closeAudioSession(), createAudioSessionState() (+5 more)
...
Cohesion: 0.17
Nodes (14): matchPureJsHpcpToChord(), extractBassSupportMapFromWav(), ALL_CHORD_NAMES, analysisCache, bassSupportCache, CHORD_FIXTURES_DIR, __dirname, getBassSupport() (+6 more)
...
Cohesion: 0.21
Nodes (12): feature, root, createTonFinderFeature(), evaluateRound(), getAllPositions(), getNotePool(), NATURAL_NOTES, positionKey() (+4 more)
...
Cohesion: 0.26
Nodes (11): buildFrequencyFrames(), computeRms(), extractHpcpAnalysisFromSamples(), extractHpcpAnalysisFromWav(), fftInPlace(), installEssentiaDetectionHarness(), CHORD_FIXTURES_DIR, createFakeChordDetectionAnalyserFromWav() (+3 more)
...
Cohesion: 0.27
Nodes (8): createGuitarOnsetState(), closeNotePlayingAudioSession(), createNotePlayingAudioSession(), openNotePlayingAudioSession(), createNotePlayingExerciseFeature(), resolveNotePlayingUI(), skipBtn, targetNoteEl
...
Cohesion: 0.36
Nodes (11): noteToFrequency(), classifyFastNoteMatcherSheetMusicFrame(), classifySheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch(), resolveSheetMusicRecognitionStrategy() (+3 more)
...
Cohesion: 0.25
Nodes (4): clampStart(), createAdvancingWait(), FakeChordDetectionAnalyser, detectFromWav()
...
## Knowledge Gaps
- **1060 isolated node(s):** `__dirname`, `url`, `OUT_DIR`, `fixtures`, `manifest` (+1055 more)
...
- **Why does `requestMicrophoneStream()` connect `Community 94` to `Community 0`, `Community 10`, `Community 81`, `Community 54`, `Community 56`, `Community 31`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `readWavFile()` connect `Community 66` to `Community 65`, `Community 72`, `Community 107`, `Community 12`, `Community 15`, `Community 80`, `Community 16`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 57`, `Community 28`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `closeAudioSession()` connect `Community 48` to `Community 81`, `Community 10`, `Community 131`, `Community 54`?**

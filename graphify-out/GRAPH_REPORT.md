...
## Corpus Check
- 333 files · ~207,956 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3119 nodes · 4786 edges · 221 communities (206 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `230ec3a2`
...
Cohesion: 0.04
Nodes (31): abort(), alignUp(), demangle(), demangleAll(), _emscripten_get_heap_size(), emscripten_realloc_buffer(), _emscripten_resize_heap(), _environ_get() (+23 more)
...
Cohesion: 0.11
Nodes (32): createOnsetTaggerFeature(), DEFAULT_SIDECAR_FIELDS, DROPDOWN_OPTIONS, NUMERIC_DROPDOWN_KEYS, addOnset(), buildSidecarWithOnsets(), clamp(), computeEnvelope() (+24 more)
...
Cohesion: 0.12
Nodes (24): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), buildFrequencyFrames(), computeDbSpectrum() (+16 more)
...
Cohesion: 0.14
Nodes (18): createFretboardToneRecognitionFeature(), btnUpdate, debugStore, menuView, resolveNotePlayingUI(), forceAppReload(), DEFAULTS, getSetting() (+10 more)
...
Cohesion: 0.12
Nodes (18): getGuitarOnsetStrategies(), getSheetMusicRecognitionStrategies(), __dirname, LIB_DIR, loadEssentiaForNode(), evaluateSheetMusicSequenceFingerprint(), SHEET_FINGERPRINT_POSITIVE_FIXTURE_FILES, initSettings() (+10 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (18): getEssentia(), createEssentiaSheetMusicStrategy(), classifyFastNoteMatcherSheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch(), setEssentiaSheetMusicStrategyInstance() (+10 more)
...
Cohesion: 0.17
Nodes (18): computeActiveBandRatio(), computeActiveBandRatioLinear(), computeBroadbandFlux(), computeSpectralNoveltyBins(), createGuitarOnsetState(), dbToLinear(), normalizeGuitarOnsetOptions(), toLinearMagnitudes() (+10 more)
...
Cohesion: 0.1
Nodes (14): decodeWav(), readWavFile(), captureGolden(), fixtures, manifest, OUT_DIR, outPath, accepted (+6 more)
...
Cohesion: 0.19
Nodes (20): classifyFrame(), createMatchState(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize(), parsePitch(), updateMatchState(), yinMinPeriods() (+12 more)
...
Cohesion: 0.17
Nodes (17): createSheetMusicReadingFeature(), getSheetMusicStorage(), loadSheetMusicPrefs(), saveSheetMusicActive(), saveSheetMusicBpm(), saveSheetMusicEndless(), saveSheetMusicShowTab(), saveSheetMusicTimeSig() (+9 more)

### Community 36 - "Community 36"
Cohesion: 0.1
Nodes (23): addFunctionWasm(), addRunDependency(), assert(), ccall(), convertJsFunctionToWasm(), createExportWrapper(), createWasm(), doCallback() (+15 more)
...
Cohesion: 0.15
Nodes (20): getNoteAtPosition(), CHROMATIC_NOTES, getAvailableNotes(), getAvailablePitches(), getPitchAtPosition(), getPositionsForNote(), getPositionsForPitch(), getRandomNote() (+12 more)
...
Cohesion: 0.12
Nodes (15): feature, root, feature, root, root, tool, createChordExerciseEssentiaFeature(), createChordRecorderTool() (+7 more)
...
Cohesion: 0.15
Nodes (15): applyGuitarBandpass(), centsDistance(), dampAttack(), detectPitch(), detectPitchHps(), detectPitchYin(), hpsFromMagnitudes(), onePoleHighpass() (+7 more)
...
Cohesion: 0.15
Nodes (13): buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets(), discoverSheetMusicSequenceFixtures(), evaluateFixture(), formatAlignmentIssueCase(), formatAlignmentSummaryCase(), formatMs() (+5 more)
...
Cohesion: 0.13
Nodes (8): feature, root, createMetronomeFeature(), MetronomeSVG, createStorageService(), metro, service, storage
...
Cohesion: 0.17
Nodes (13): CHROMATIC_NOTES, drawRandom(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS, evaluateRound(), getNotePool(), NATURAL_NOTES (+5 more)
...
Cohesion: 0.2
Nodes (10): createAkkordUebersichtFeature(), filter, getFilteredChords(), renderGrid(), ROOT_ORDER, TYPE_ORDER, createChordRecorderUI(), chordStringToFretboardIndex() (+2 more)

### Community 91 - "Community 91"
Cohesion: 0.14
Nodes (8): feature, root, GtExerciseHeader, feature, root, createRecordingsOverviewFeature(), backLink, header
...
Cohesion: 0.2
Nodes (9): mixedSpectrum(), moderateFewBins, narrow, opts, reattack, result, sparseAttack, spectrum() (+1 more)
...
Cohesion: 0.5
Nodes (3): feature, root, createAkkordTrainerFeature()
...
## Knowledge Gaps
- **1447 isolated node(s):** `__dirname`, `url`, `ANALYSIS_OPTION_KEYS`, `DETECTOR_OPTION_KEYS`, `OUT_DIR` (+1442 more)
...
- **Why does `readWavFile()` connect `Community 28` to `Community 32`, `Community 33`, `Community 2`, `Community 41`, `Community 73`, `Community 108`, `Community 13`, `Community 18`, `Community 54`, `Community 88`, `Community 89`, `Community 56`, `Community 27`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `averageHpcps()` connect `Community 96` to `Community 33`, `Community 5`, `Community 70`, `Community 71`, `Community 8`, `Community 43`, `Community 13`, `Community 47`, `Community 19`, `Community 55`, `Community 88`, `Community 125`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 97` to `Community 0`, `Community 35`, `Community 103`, `Community 74`, `Community 17`, `Community 19`?**

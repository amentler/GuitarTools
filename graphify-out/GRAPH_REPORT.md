...
## Corpus Check
- 273 files · ~166,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2284 nodes · 3475 edges · 163 communities (152 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `22e2abd8`
...
5. `getRecommendedFftSize()` - 19 edges
6. `matchChordPath()` - 19 edges
7. `buildChordTemplates()` - 18 edges
8. `classifyFrame()` - 16 edges
...
Cohesion: 0.06
Nodes (35): applyGuitarBandpass(), centsDistance(), dampAttack(), detectPitch(), detectPitchHps(), detectPitchYin(), hpsFromMagnitudes(), onePoleHighpass() (+27 more)
...
Cohesion: 0.07
Nodes (26): feature, root, feature, root, root, tool, createChordExerciseEssentiaFeature(), createChordRecorderTool() (+18 more)
...
Cohesion: 0.08
Nodes (31): classifyFrame(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize(), parsePitch(), yinMinPeriods(), adaptiveBuffer(), after (+23 more)
...
Cohesion: 0.13
Nodes (23): createMatchState(), classifySheetMusicFixture(), collectWavFiles(), discoverSheetMusicSequenceFixtures(), evaluateFixture(), evaluateSheetMusicSequenceFingerprint(), formatPercent(), formatSheetMusicSequenceFingerprintReport() (+15 more)
...
Cohesion: 0.13
Nodes (18): computeFrameRms(), consumeOnsetGate(), createOnsetGateState(), isOnsetGateOpen(), updateOnsetGate(), replay, res, result (+10 more)
...
Cohesion: 0.12
Nodes (12): createNotePlayingAudioSession(), createNotePlayingExerciseFeature(), resolveNotePlayingUI(), accepted, audioContext, feature, RIGHT_G3, samples (+4 more)
...
Cohesion: 0.2
Nodes (14): DEFAULTS, getSetting(), setSetting(), SETTING_KEYS, storageService, syncSheetMusicUI(), feature, root (+6 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (13): collectWavs(), discoverNoteAudioFixtures(), inferPitchFromPath(), NOTE_AUDIO_FIXTURES_DIR, parsePitchToken(), decodeWav(), readWavFile(), captureGolden() (+5 more)

### Community 38 - "Community 38"
Cohesion: 0.16
Nodes (15): ANALYSER_GOLDENS_DIR, evaluateOpenStringNoteFingerprint(), evaluateSingleNoteOnsetFixture(), FIXTURES_DIR, formatOpenStringNoteFingerprintReport(), formatPercent(), loadAnalyserGolden(), NOTE_AUDIO_FIXTURES (+7 more)
...
Cohesion: 0.23
Nodes (12): createGuitarOnsetState(), createSheetMusicReadingFeature(), getSheetMusicStorage(), loadSheetMusicPrefs(), saveSheetMusicActive(), saveSheetMusicBpm(), saveSheetMusicEndless(), saveSheetMusicShowTab() (+4 more)
...
Cohesion: 0.13
Nodes (11): GUITAR_SIZES, GUITAR_STRINGS, PRE_COUNTDOWN, ROOT_ORDER, STRUM_MODI, TECHNIKEN, TYPE_ORDER, createChordRecorderAudio() (+3 more)
...
Cohesion: 0.18
Nodes (12): updateMatchState(), assertSequenceFixture(), deduplicateConsecutive(), __dirname, __filename, getSequenceFixture(), SEQUENCES_DIR, runSequenceSimulation() (+4 more)
...
Cohesion: 0.19
Nodes (13): buildChordTemplates(), evaluateEssentiaFingerprintConfusion(), formatEssentiaFingerprintReport(), formatPercent(), safeDivide(), summarizeRow(), __dirname, preparedFixtures (+5 more)
...
Cohesion: 0.14
Nodes (13): averageHpcps(), toAverageHpcp(), ALL_CHORD_NAMES, ALL_TEMPLATES, __dirname, NON_STRICT_MATRIX_CASES, POSITIVE_PREPARED_FIXTURES, PREPARED_FIXTURES (+5 more)
...
Cohesion: 0.19
Nodes (12): computeActiveBandRatio(), computeBroadbandFlux(), dbToLinear(), toLinearMagnitudes(), updateGuitarOnsetDetector(), mixedSpectrum(), narrow, reattack (+4 more)
...
Cohesion: 0.2
Nodes (10): buildFrequencyFrames(), computeRms(), extractHpcpAnalysisFromSamples(), extractHpcpAnalysisFromWav(), fftInPlace(), installEssentiaDetectionHarness(), analysis, CHORD_FIXTURES_DIR (+2 more)
...
Cohesion: 0.23
Nodes (9): feature, root, createAkkordUebersichtFeature(), filter, getFilteredChords(), renderGrid(), ROOT_ORDER, TYPE_ORDER (+1 more)
...
Cohesion: 0.18
Nodes (10): CHORD_FAMILIES, CHORD_ROOTS, validateFingerData(), badChords, chordName, errors, keys, pc (+2 more)
...
## Knowledge Gaps
- **1026 isolated node(s):** `__dirname`, `url`, `OUT_DIR`, `fixtures`, `manifest` (+1021 more)
...
- **Why does `requestMicrophoneStream()` connect `Community 91` to `Community 32`, `Community 0`, `Community 43`, `Community 13`, `Community 47`, `Community 61`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `readWavFile()` connect `Community 37` to `Community 32`, `Community 2`, `Community 67`, `Community 68`, `Community 38`, `Community 8`, `Community 9`, `Community 73`, `Community 11`, `Community 51`, `Community 19`, `Community 23`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `averageHpcps()` connect `Community 59` to `Community 67`, `Community 68`, `Community 6`, `Community 7`, `Community 13`, `Community 46`, `Community 147`, `Community 53`, `Community 54`, `Community 24`, `Community 28`, `Community 29`, `Community 94`?**

...
## Corpus Check
- 615 files · ~933,644 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 31271 nodes · 42063 edges · 2110 communities (2087 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `848ec544`
...
- `evaluateOpenStringNoteFingerprintForStrategy()` --calls--> `progress`  [INFERRED]
  /workspace/GuitarTools/tests/helpers/sheetMusicNoteFingerprint.js → scripts/sheet-and-note-fingerprint.mjs

## Communities (2110 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.15
Nodes (25): createGuitarOnsetState(), collectWavs(), discoverNoteAudioFixtures(), inferPitchFromPath(), NOTE_AUDIO_FIXTURES_DIR, parsePitchToken(), ANALYSER_GOLDENS_DIR, classifySheetMusicFixture() (+17 more)
...
Cohesion: 0.06
Nodes (67): classifyFrame(), createMatchState(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize(), parsePitch(), updateMatchState(), yinMinPeriods() (+59 more)
...
Cohesion: 0.04
Nodes (46): feature, root, feature, root, feature, root, createAkkordfolgenTrainerFeature(), createAkkordUebersichtFeature() (+38 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (87): buildWasmSandbox(), __dirname, LIB_DIR, loadEssentiaForNode(), resampleLinear(), loadSequenceFixtureAudio(), evaluateOpenStringNoteOnsetReport(), buildOnsetAcceptAlignment() (+79 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (60): buildFeatureOrder(), computeBandEnergy(), computeCrestFactor(), computeHFC(), computeLinearMagnitudes(), computeLogBandFlux(), computeMFCC(), computeSpectralCentroid() (+52 more)
...
Cohesion: 0.06
Nodes (69): binToUnit(), computeActiveBandRatio(), computeActiveBandRatioLinear(), computeBroadbandFlux(), computeCrestFactor(), computeHighFrequencyContent(), computeSpectralCentroid(), computeSpectralFlatness() (+61 more)
...
Cohesion: 0.08
Nodes (40): GLOBAL_DEBUG_DEFAULTS, clonePayload(), createBasePageContext(), createGlobalDebugStore(), loadPersistedState(), normalizeString(), resolvePageUrl(), toIsoTimestamp() (+32 more)
...
Cohesion: 0.07
Nodes (53): _analysisFrames, appendAxes(), appendOnsetMarkers(), appendXAxis(), appendYGrid(), _buildTooltipContent(), createSection(), _crosshairLines (+45 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (50): averageHpcps(), buildChordTemplates(), matchEssentiaFingerprintHpcpToChord(), evaluateEssentiaFingerprintConfusion(), formatEssentiaFingerprintReport(), formatPercent(), safeDivide(), summarizeRow() (+42 more)
...
Cohesion: 0.18
Nodes (17): closeAkkordfolgenAudioSession(), createAkkordfolgenAudioSession(), openAkkordfolgenAudioSession(), closeAudioSession(), createAudioSessionState(), openAudioSession(), closeAudioSession(), closeNotePlayingAudioSession() (+9 more)
...
Cohesion: 0.11
Nodes (5): MetronomeLogic, PlaybackController, barIndices, calls, pc
...
Cohesion: 0.11
Nodes (31): CHORD_DETECTION_PATHS, getDefaultChordDetectionPath(), isEssentiaDetectionPath(), resolveChordDetectionPath(), audioSession, CHORD_TEMPLATES, computeHpcp(), computeHpcpEssentia() (+23 more)

### Community 288 - "Community 288"
Cohesion: 0.11
Nodes (31): matchPureJsHpcpToChord(), extractBassSupportMapFromWav(), evaluateChordRecognitionConfusion(), formatChordRecognitionJsfingerprintReport(), formatChordRecognitionMetricsReport(), formatPercent(), safeDivide(), summarizeRow() (+23 more)
...
Cohesion: 0.1
Nodes (38): buildCollectionZip(), buildRecordingZip(), buildZip(), crc32(), CRC_TABLE, downloadBlob(), writeU16(), writeU32() (+30 more)
...
Cohesion: 0.07
Nodes (32): buildZip(), crc32(), CRC_TABLE, downloadBlob(), writeU16(), writeU32(), buildCollectionZipMock, buildRecordingZipMock (+24 more)

### Community 300 - "Community 300"
Cohesion: 0.11
Nodes (35): matchHpcpToChord(), CATALOG_FILE, CHORD_FIXTURES_DIR, CHORD_TEMPLATES, collectOpenStrumNegativeFixtures(), collectPositiveFolderFixtures(), compareStrings(), __dirname (+27 more)
...
Cohesion: 0.19
Nodes (27): applyNoteSwitchHysteresis(), buildGuidedDisplay(), evaluateTrend(), getGuidedFeedback(), getPitchDirection(), getTuningState(), GUIDED_TUNING_STEPS, pushAndMedian() (+19 more)
...
Cohesion: 0.08
Nodes (40): createAkkordTrainerFeature(), fretboardIndexToChordString(), createFretboardToneRecognitionFeature(), clampWeight(), createSrsStore(), getWeight(), getWeights(), loadWeights() (+32 more)
...
Cohesion: 0.1
Nodes (37): validateChord(), filter, getFilteredChords(), initFilters(), renderGrid(), ROOT_ORDER, TYPE_ORDER, getEssentia() (+29 more)
...
Cohesion: 0.05
Nodes (82): createAudioTransport(), collectFrameData(), computeDbSpectrum(), fftInPlace(), getEssentia(), loadScript(), createEssentiaSheetMusicStrategy(), frameRms() (+74 more)
...
Cohesion: 0.24
Nodes (21): createGuitarTunerFeature(), createAudioSessionState(), openAudioSession(), nextGuidedStepState(), startGuidedModeState(), stopGuidedModeState(), createAnalysisRuntime(), createGuidedState() (+13 more)
...
Cohesion: 0.13
Nodes (13): code:block1 (/graphify                                             # full), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash (python3 -m graphify.watch INPUT_PATH --debounce 3), code:bash (graphify hook install    # install), For --cluster-only, For git commit hook, For /graphify add (+5 more)
...
Cohesion: 0.13
Nodes (22): computed, __dirname, el, firstChartWrap, firstMarker, firstPlayhead, firstSvg, flyout (+14 more)
...
Cohesion: 0.15
Nodes (16): buildZip(), crc32(), buildCollectionZipMock, buildRecordingZipMock, data, downloadBlobMock, enc, eocd (+8 more)
...
Cohesion: 0.14
Nodes (23): collectFixtureFiles(), discoverSequenceFixtureSources(), normalizeLookupPath(), normalizeRelativePath(), parseManifest(), readLooseSequencePair(), readSequenceZip(), resolveSequenceFixtureSource() (+15 more)
...
Cohesion: 0.17
Nodes (16): root, tool, createChordRecorderTool(), getDurationMs(), getSortedChordNames(), GUITAR_SIZES, GUITAR_STRINGS, loadInventory() (+8 more)
...
Cohesion: 0.22
Nodes (16): addEventListener(), audioSession, cards, close, constructor(), createMockStorageService(), firstChord, manageButton (+8 more)
...
Cohesion: 0.28
Nodes (11): DEFAULT_CONSTRAINTS, requestMicrophoneStream(), resolveGetUserMedia(), stopMicrophoneStream(), createChordRecorderAudio(), encodeWav(), constraints, getUserMedia (+3 more)
...
Cohesion: 0.28
Nodes (12): arcPath(), initTunerSVG(), polarPoint(), svgEl(), updateTunerDisplay(), angle, { cents }, dot (+4 more)
...
Cohesion: 0.22
Nodes (12): buf, buffer, detected, freq, hz, level, mags, makeHarmonicSpectrum() (+4 more)
...
Cohesion: 0.12
Nodes (30): GERMAN_TO_CHROMA, getExpectedNoteClasses(), matchDetectedNotes(), parseChordName(), TYPE_INTERVALS, buildBassNeighborScores(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS (+22 more)
...
Cohesion: 0.09
Nodes (43): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), buildFrequencyFrames(), computeDbSpectrum() (+35 more)
...
Cohesion: 0.38
Nodes (9): evaluateRound(), getAllPositions(), getNotePool(), NATURAL_NOTES, positionKey(), correctPositions, pool, positions (+1 more)
...
Cohesion: 0.3
Nodes (8): createAudioContext(), createAudioContextFactory(), resolveAudioContextCtor(), audioContext, ExplicitAudioContext, factory, MockAudioContext, WebkitAudioContext
...
Cohesion: 0.37
Nodes (9): CHROMATIC_NOTES, drawRandom(), getNoteAtPosition(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS, draws, pos (+1 more)

### Community 1765 - "Community 1765"
Cohesion: 0.05
Nodes (54): result, t1, t2, t5, a, b, bars, batch1 (+46 more)
...
Cohesion: 0.18
Nodes (11): fixtureOverrides, open-strings/medium.wav, sheet-music-reading/4-4_40bpm_EGADB_9low6.wav, maxOnsets, minOnsets, role, weight, maxOnsets (+3 more)
...
Cohesion: 0.05
Nodes (63): detectNoteFromSamples(), getAudioFixtures(), assertSequenceFixture(), deduplicateConsecutive(), __dirname, __filename, getSequenceFixture(), SEQUENCES_DIR (+55 more)
...
Cohesion: 0.18
Nodes (13): computeTaggedOnsetMetrics(), DEFAULT_TAGGED_ONSET_METRIC_OPTIONS, normalizeOnsets(), normalizeTrainingName(), percentile(), resolveOnsetModelTrainingStatus(), safeDivide(), feature (+5 more)
...
## Knowledge Gaps
- **18457 isolated node(s):** `test`, `test:unit`, `test:precommit`, `test:audio:goldens`, `test:sync` (+18452 more)
...
- **Why does `requestMicrophoneStream()` connect `Community 1708` to `Community 387`, `Community 10`, `Community 16`, `Community 1752`, `Community 346`, `Community 670`, `Community 287`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `test`, `test:unit`, `test:precommit` to the rest of the system?**
  _18483 weakly-connected nodes found - possible documentation gaps or missing edges._

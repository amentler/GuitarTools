# Graph Report - GuitarToolsCopilot  (2026-05-23)

## Corpus Check
- 615 files · ~933,509 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 31270 nodes · 42062 edges · 2111 communities (2088 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17a119e2`
...
- `runSheetMusicSequenceSimulation()` --calls--> `getSheetMusicRecognitionStrategies()`  [INFERRED]
  tests/helpers/sheetMusicSequenceFingerprint.js → /workspace/GuitarTools/js/shared/audio/sheetMusicRecognition.js
- `runSheetMusicSequenceSimulation()` --calls--> `updateSheetMusicMatchState()`  [INFERRED]
  tests/helpers/sheetMusicSequenceFingerprint.js → /workspace/GuitarTools/js/shared/audio/sheetMusicRecognition.js
- `evaluateSheetMusicSequenceFingerprint()` --calls--> `getSheetMusicRecognitionStrategies()`  [INFERRED]
  tests/helpers/sheetMusicSequenceFingerprint.js → /workspace/GuitarTools/js/shared/audio/sheetMusicRecognition.js
- `loadFixture()` --calls--> `readWavFile()`  [EXTRACTED]
  tests/unit/noteOnsetGateAudio.test.js → /workspace/GuitarTools/tests/helpers/wavDecoder.js
- `analyzeAudio()` --calls--> `frequencyToNote()`  [INFERRED]
  js/tools/audioAnalyse/audioAnalyseEngine.js → /workspace/GuitarTools/js/domain/pitch/pitchCore.js

## Communities (2111 total, 23 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.11
Nodes (31): createGuitarOnsetState(), collectWavs(), discoverNoteAudioFixtures(), inferPitchFromPath(), NOTE_AUDIO_FIXTURES_DIR, parsePitchToken(), ANALYSER_GOLDENS_DIR, classifySheetMusicFixture() (+23 more)
...
Cohesion: 0.06
Nodes (68): createEssentiaSheetMusicStrategy(), frameRms(), parsePitch(), classifyFrame(), createMatchState(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize() (+60 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (53): getDurationMs(), getSortedChordNames(), GUITAR_SIZES, GUITAR_STRINGS, loadInventory(), PRE_COUNTDOWN, ROOT_ORDER, sleep() (+45 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (40): feature, root, feature, root, feature, root, createAkkordfolgenTrainerFeature(), createAkkordUebersichtFeature() (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (91): createOnsetGateState(), buildWasmSandbox(), __dirname, LIB_DIR, loadEssentiaForNode(), resampleLinear(), loadSequenceFixtureAudio(), evaluateOpenStringNoteFingerprintForStrategy() (+83 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (61): buildContextFeatures(), buildFeatureOrder(), computeBandEnergy(), computeCrestFactor(), computeHFC(), computeLinearMagnitudes(), computeLogBandFlux(), computeMFCC() (+53 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (161): additionalImplementations(), addSymbol(), adjustPadAndReturnShape(), adjustPadsBasedOnAutoPad(), adjustPoolAttributes(), alloc(), appendVariableUniforms(), areEqual() (+153 more)
...
Cohesion: 0.09
Nodes (34): createListeningController(), createNoteHandler(), createPlaybackControl(), ALL_STRING_INDICES, createSheetMusicReadingFeature(), getSheetMusicStorage(), loadSheetMusicPrefs(), saveSheetMusicActive() (+26 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (78): n, a(), ab(), ac(), Ae(), $b(), Bb(), Be() (+70 more)
...
Cohesion: 0.15
Nodes (43): _analysisFrames, appendAxes(), appendOnsetMarkers(), appendXAxis(), appendYGrid(), _buildTooltipContent(), createSection(), _crosshairLines (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (38): buildChordTemplates(), matchEssentiaFingerprintHpcpToChord(), evaluateEssentiaFingerprintConfusion(), formatEssentiaFingerprintReport(), formatPercent(), safeDivide(), summarizeRow(), toAverageHpcp() (+30 more)
...
Cohesion: 0.12
Nodes (28): closeAkkordfolgenAudioSession(), createAkkordfolgenAudioSession(), openAkkordfolgenAudioSession(), closeAudioSession(), createAudioSessionState(), openAudioSession(), DEFAULT_CONSTRAINTS, requestMicrophoneStream() (+20 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (48): beamSize, candidatesPerRound, fixturesDir, globalResetInterval, minScoreImprovement, outputDir, parameters, confirmedFluxFactor (+40 more)
...
Cohesion: 0.09
Nodes (47): appendRow, buildCollectionZip, buildDom(), buildRecordingZip, buildZip, closeAudioSession, container, destroy() (+39 more)
...
Cohesion: 0.05
Nodes (44): 1. Layer-Architektur, 2.1 Kritische Verstöße, 2.1 Kritische Verstöße, 2.2 Grenzwertige Dateien (< 10% über Limit), 2.2 Grenzwertige Dateien (< 10% über Limit), 2.3 Akzeptable Ausnahmen, 2.4 Refaktorierungs-Empfehlungen, 2. Dateigrößen-Verstöße (+36 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (42): devDependencies, @emnapi/core, @emnapi/runtime, eslint, @eslint/js, globals, husky, jsdom (+34 more)
...
Cohesion: 0.06
Nodes (40): Betroffene Dateien, code:js (// Dateigröße als lesbaren String), code:js ({), code:js (// Liest Metadaten der Notenlesen-Aufnahme (ohne WAV-Bytes z), code:js (// Lädt WAV-Bytes + Manifest aus beliebiger Aufnahme-Quelle), code:js (// Am Ende von mount(), nach wireDropzone(ui):), code:js (// Extrahiert den core aus loadWav (ab reader.onload-Body)), code:js (import { loadRecordingFromSource } from '../../shared/record) (+32 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (40): Default Strategy Detail, Default Strategy Detail, Default Strategy Detail, Failures, False Negatives, False Positives, Guitar Onset Count, Onset Count per Fixture (+32 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (82): std, bandRatio.current, bandRatio.previous_1, bandRatio.previous_2, bandRatio.previous_3, broadbandFlux.current, broadbandFlux.mad_last_30, broadbandFlux.max_last_5 (+74 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (42): A1: Fehler-Taxonomie statt nur Count-Vergleich, A2: Feature-Separierbarkeit pro Frame, A3: Analyse relativ zum letzten echten Onset, A4: Multiband-Analyse, A5: Zeitaufloesungs-Analyse, A6: Per-Feature-Ablation, A7: Timing-Qualitaet staerker gewichten, A8: Bewertungslogik zwischen Sweep und Fingerprint vereinheitlichen (+34 more)
...
Cohesion: 0.05
Nodes (38): Berechtigungen & Datenschutz, Checks, code:bash (python -m http.server 8000), code:bash (npx http-server -p 8000), code:bash (npm run lint), code:text (index.html          – Startseite / Menü), Features, GuitarTools – Gitarren-Lerntools (+30 more)
...
Cohesion: 0.22
Nodes (14): buildInventoryEntry(), countMatchingRecordings(), isChordSufficient(), CHORDS_DIR, collectSidecars(), __dirname, inventory, OUT_FILE (+6 more)
...
Cohesion: 0.06
Nodes (67): CHORD_DETECTION_PATHS, getDefaultChordDetectionPath(), isEssentiaDetectionPath(), resolveChordDetectionPath(), buildBassSupportByChord(), audioSession, CHORD_TEMPLATES, computeHpcp() (+59 more)

### Community 288 - "Community 288"
Cohesion: 0.18
Nodes (18): extractBassSupportMapFromWav(), evaluateChordRecognitionConfusion(), formatChordRecognitionJsfingerprintReport(), formatChordRecognitionMetricsReport(), formatPercent(), safeDivide(), summarizeRow(), toAverageHpcp() (+10 more)

### Community 289 - "Community 289"
Cohesion: 0.06
Nodes (36): Bestehende Tests, die angepasst werden müssen, Bestehende Tests, die angepasst werden müssen, Betroffene Dateien, code:js (/**), code:js (function downloadRecordings() {), code:js (export async function downloadAllAsZip(basename = 'chord-rec), code:js (function handleExport(ui) {), code:js (export async function getRecordingsForZip(recordings) {) (+28 more)
...
Cohesion: 0.1
Nodes (40): buildCollectionZip(), buildRecordingZip(), buildZip(), crc32(), CRC_TABLE, downloadBlob(), readRecordingZip(), readZip() (+32 more)

### Community 293 - "Community 293"
Cohesion: 0.06
Nodes (32): Ablage nach Download, Akustische Ausgabe, Beispiel: Alles aktiv, Beispiel: Kein Plektrum, nur Single-Strum, Chord Recorder Tool — Detailspec, code:block1 (┌─────────────────────────────────────────────────┐), code:block2 (┌──────────────────────────────────────────────────┐), code:block3 (gdur_fingernagel_laut_single_a3f2x.wav) (+24 more)
...
Cohesion: 0.1
Nodes (54): DEFAULT_SIDECAR_FIELDS, DROPDOWN_OPTIONS, NUMERIC_DROPDOWN_KEYS, wireOnsetTaggerEvents(), closeLoadMenu(), wireLoadMenu(), addOnset(), addOnsetWithIndex() (+46 more)

### Community 296 - "Community 296"
Cohesion: 0.05
Nodes (42): Current Architecture, Current Architecture (Phase 1 Web Components), Current Modules, Feature Status, Gemini Product State - GuitarTools, graphify, `<gt-fretboard>` Web Component, Guitar Tuner Detection (+34 more)

### Community 297 - "Community 297"
Cohesion: 0.1
Nodes (42): applyGuitarBandpass(), buildAdaptiveThreshold(), centsDistance(), dampAttack(), detectPitch(), detectPitchHps(), detectPitchYin(), estimateNoiseFloorRms() (+34 more)

### Community 298 - "Community 298"
Cohesion: 0.15
Nodes (37): feature, root, createRecordingsOverviewFeature(), buildAudioAnalyseUrl(), buildDisplayName(), buildOnsetTaggerUrl(), buildTrainingDataOnsetTaggerUrl(), buildZipEntryName() (+29 more)

### Community 299 - "Community 299"
Cohesion: 0.08
Nodes (26): buildCollectionZipMock, buildRecordingZipMock, cdOffset, collectBrowserEnvironmentMock, content, CRC_TABLE_TEST, data, downloadBlobMock (+18 more)

### Community 300 - "Community 300"
Cohesion: 0.16
Nodes (27): matchHpcpToChord(), CATALOG_FILE, CHORD_FIXTURES_DIR, CHORD_TEMPLATES, collectOpenStrumNegativeFixtures(), collectPositiveFolderFixtures(), compareStrings(), __dirname (+19 more)

### Community 301 - "Community 301"
Cohesion: 0.07
Nodes (29): Bestehende Tests, die angepasst werden müssen, Betroffene Dateien, code:js (/**), code:js (function downloadRecordings() {), code:js (export async function downloadAllAsZip(basename = 'chord-rec), code:js (function handleExport(ui) {), code:js (export async function getRecordingsForZip(recordings) {), code:html (<div class="tagger-load-btn">) (+21 more)

### Community 302 - "Community 302"
Cohesion: 0.07
Nodes (28): analyzeIntervalMs, exact, extremeOver, extremeUnder, over, totalOnsets, under, onsetDetectorOptions (+20 more)
...
Cohesion: 0.18
Nodes (14): best, bestByStrategy, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, evaluated, mode (+6 more)
...
Cohesion: 0.07
Nodes (70): createGuitarTunerFeature(), nextGuidedStepState(), startGuidedModeState(), stopGuidedModeState(), createAnalysisRuntime(), createGuidedState(), createTunerDisplayState(), resetForMount() (+62 more)
...
Cohesion: 0.12
Nodes (23): createFretboardToneRecognitionFeature(), evaluateAnswer(), initGameState(), pitchToVfKey(), renderNoteOnStaff(), renderNotePositionsTab(), tabEl(), toGuitarWrittenPitch() (+15 more)
...
Cohesion: 0.09
Nodes (25): 1. `essentiaChordLogic.js` (996 → ~726 Zeilen), 2. `audioAnalyseSVG.js` (840 → ~735 Zeilen), 3. `onsetTagger.js` (832 → ~632 Zeilen), 4. `sheetMusicReading.js` (1080 → ~775 Zeilen), Betroffene Dateien & Änderungen, Betroffene Dateien & Änderungen, code:js (// sheetMusicReadingEndless.js), code:js (const endlessHelpers = createEndlessHelpers({ getState: () =) (+17 more)

### Community 349 - "Community 349"
Cohesion: 0.08
Nodes (25): Betroffene Dateien, code:block1 (┌───────────────────────────────────────────────────────────), code:json ({), code:js (export function computeEnvelope(samples, sampleRate, startSe), code:js (export function renderWaveform(container, samples, sampleRat), code:js (export function createOnsetTaggerFeature()), E2E-Tests (`tests/e2e/onset-tagger.spec.js`), Implementierungsstatus (+17 more)
...
Cohesion: 0.08
Nodes (24): Betroffene Dateien, code:js (/**), code:js (/**), code:block3 (Testfall 1: detectOnsetsOffline ist eine async-Funktion), code:js (// VORHER: requestAnimationFrame(() => { try { const result ), code:bash (npm run test:precommit   # alle Unit-Tests grün), Implementierungsreihenfolge, `js/shared/audio/collectFrameData.js` (+16 more)
...
Cohesion: 0.13
Nodes (25): bar, chartBlocks, computed, __dirname, fileInput, firstSvg, FIXTURE_WAV, FIXTURE_ZIP (+17 more)
...
Cohesion: 0.08
Nodes (23): Betroffene Dateien, code:js (/**), code:js (/**), code:block3 (Testfall 1: detectOnsetsOffline ist eine async-Funktion), code:js (// VORHER: requestAnimationFrame(() => { try { const result ), code:bash (npm run test:precommit   # alle Unit-Tests grün), Implementierungsreihenfolge, `js/shared/audio/collectFrameData.js` (+15 more)
...
Cohesion: 0.1
Nodes (20): code:block1 (Phase 1 (Diagnostik) → Phase 2 (Vorfilter) → Phase 3 (RMS-Ga), Empfohlene Reihenfolge, Essentia PitchYin – Verbesserungsplan für die Noten-lesen-Erkennung, Essentia PitchYin – Verbesserungsplan für die Noten-lesen-Erkennung, Haupt-Fehlerquellen, Ist-Analyse (`npm run sfp`), Offene Fragen / Klärungsbedarf, Offene Fragen / Klärungsbedarf (+12 more)
...
Cohesion: 0.11
Nodes (18): beatDots, feature, getEssentia, getSetting, init(), metronomeInit, metronomeSetBeatsPerMeasure, metronomeSetBpm (+10 more)
...
Cohesion: 0.1
Nodes (20): score, acceptableMatchMinScore, acceptableMatchScore, acceptableWindowMs, duplicatePenalty, extremeOverMultiplier, extremeOverPenalty, extremeUnderMultiplier (+12 more)
...
Cohesion: 0.1
Nodes (9): url, url, url, buildPrecacheManifest(), CORE_PRECACHED_URLS, PAGE_PRECACHED_URLS, PRECACHE_URLS, REQUIRED_URLS (+1 more)
...
Cohesion: 0.11
Nodes (29): buildProgression(), createBeatChordSync(), generateRandomProgression(), getChordName(), MAJOR_KEYS, PROGRESSIONS, ROMAN_NUMERALS, resolveAkkordfolgenUI() (+21 more)
...
Cohesion: 0.11
Nodes (29): validateChord(), getEssentia(), getRandomChord(), LEVELS, A_SHAPE_OFFSETS, BASE_CHORDS, buildChordMeta(), buildCompleteChordCatalog() (+21 more)

### Community 390 - "Community 390"
Cohesion: 0.11
Nodes (18): parameters, analyzeIntervalMs, confirmedFluxFactor, confirmedMinBandRatio, confirmedMinFlux, confirmedRmsFactor, confirmedRmsMinDelta, confirmedSpectralNoveltyMinBins (+10 more)
...
Cohesion: 0.11
Nodes (17): bpm, browserEnv, browser, browserVersion, language, model, os, osVersion (+9 more)
...
Cohesion: 0.1
Nodes (56): u(), a(), ab(), bb(), cb(), Da(), db(), E() (+48 more)

### Community 420 - "Community 420"
Cohesion: 0.22
Nodes (16): advance(), chordA, chordB, deferred(), detectChordEssentia, feature, firstDetection, getEssentia (+8 more)
...
Cohesion: 0.12
Nodes (17): parameters, analyzeIntervalMs, confirmedFluxFactor, confirmedMinBandRatio, confirmedMinFlux, confirmedRmsFactor, confirmedRmsMinDelta, confirmedSpectralNoveltyMinBins (+9 more)

### Community 423 - "Community 423"
Cohesion: 0.12
Nodes (17): parameters, confirmedFluxFactor, confirmedMinBandRatio, confirmedMinFlux, confirmedRmsFactor, confirmedRmsMinDelta, confirmedSpectralNoveltyMinBins, cooldownFrames (+9 more)
...
Cohesion: 0.18
Nodes (16): chord, chordKey, durationSeconds, guitarSize, guitarStrings, quality, failReasons, passed (+8 more)
...
Cohesion: 0.06
Nodes (95): appendResult(), bestForStrategy(), compactResult(), DEFAULT_WORKER_COUNT, dispatchBatch(), dueToStop(), estimateAnalysisCost(), estimateFrameCount() (+87 more)

### Community 529 - "Community 529"
Cohesion: 0.15
Nodes (4): getUserMedia(), missedNotes, SilentAnalyserNode, SilentAudioContext
...
Cohesion: 0.16
Nodes (16): __addDays(), __arraySum(), ___assert_fail(), _atexit(), ___cxa_atexit(), __embind_register_std_string(), intArrayFromString(), __isLeapYear() (+8 more)

### Community 532 - "Community 532"
Cohesion: 0.12
Nodes (15): 1. Architektur-Übersicht, 1. Architektur-Übersicht, 2. Signal-Verarbeitungskette, 3. Pitch-Detection-Algorithmen, 4. Stabilisierung & Fehlerkorrektur, 5. Guided Tuning Mode, 6. Adaptive Noise Gate, EMA-Glättung (Exponential Moving Average) (+7 more)

### Community 533 - "Community 533"
Cohesion: 0.12
Nodes (16): confirmedFluxFactor, confirmedMinBandRatio, confirmedMinFlux, confirmedRmsFactor, confirmedRmsMinDelta, confirmedSpectralNoveltyMinBins, cooldownFrames, cooldownOverrideFactor (+8 more)
...
Cohesion: 0.14
Nodes (13): 1. Trainings-Review-Katalog erzeugen, 2. Aktuellen Kandidaten prüfen, 3. Kandidaten übernehmen (nach Training), 4. Nach Übernahme validieren, code:bash (npm run review:android-firefox), code:bash (cat models/onset_detector_android_firefox.metrics.json), code:bash (./apply_android_firefox_onset_detector.sh), code:bash (npm run sfp) (+5 more)
...
Cohesion: 0.12
Nodes (15): Analyse-Engine (`analyzeAudio`), Audio-Analyse Werkzeug, code:block1 (Noten lesen (stopRecording)), code:ts ({), code:js (CHART_W = 1000), Crosshair, Dateien, Datenfluss (+7 more)
...
Cohesion: 0.06
Nodes (76): collectFrameData(), computeDbSpectrum(), fftInPlace(), getEssentia(), loadScript(), BROADBAND_OR_GUITAR_ONSET_OPTIONS, BROADBAND_OR_NORMALIZED_OPTIONS, _buildStrategyFromEntry() (+68 more)
...
Cohesion: 0.05
Nodes (80): apply_app_peak_picking(), apply_negative_sampling(), build_eval_files(), compute_metrics(), concat_files(), evaluate_app_peak_picking(), export_onnx(), find_best_f1_threshold() (+72 more)
...
Cohesion: 0.16
Nodes (13): AI Collaboration & Documentation, Dateien, Implementierter Stand (laut backlog.md), `playbackBar.js`, `playbackController.js`, `sheetMusicLogic.js`, `sheetMusicReading.js`, sheetMusicReading – Noten lesen Übung (+5 more)

### Community 586 - "Community 586"
Cohesion: 0.18
Nodes (13): browser, capture, fftSize, frequencyBinCount, hopMs, requestedCaptureMs, sampleRate, sourceDurationMs (+5 more)
...
Cohesion: 0.14
Nodes (13): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, r002-guitar-onset-legacy-bandpass-0012-d7d21868 (+5 more)

### Community 593 - "Community 593"
Cohesion: 0.14
Nodes (13): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, r006-guitar-onset-legacy-bandpass-0048-8ba5dd8f (+5 more)
...
Cohesion: 0.14
Nodes (13): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, r006-guitar-onset-legacy-bandpass-0005-ff61c6e1 (+5 more)
...
Cohesion: 0.14
Nodes (13): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, r021-guitar-onset-legacy-bandpass-0012-8bdb0bee (+5 more)

### Community 598 - "Community 598"
Cohesion: 0.14
Nodes (13): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, r048-guitar-onset-legacy-bandpass-0083-d1b08295 (+5 more)
...
Cohesion: 0.1
Nodes (20): metrics, confusion_matrix, f1, pr_auc, precision, probability_summary, recall, roc_auc (+12 more)
...
Cohesion: 0.16
Nodes (12): code:text (my-open-string-run.zip), code:text (tests/fixtures/sequences/<category>/<name>-tagged.zip), code:text (<name>.wav), code:text (tests/fixtures/sequences/<category>/<name>.wav), code:text (tests/fixtures/sequences/open-strings/open_strings_take_01.w), code:json ({), code:json ({), Erwartete ZIP-Struktur (+4 more)

### Community 605 - "Community 605"
Cohesion: 0.11
Nodes (19): 10. Documentation Freshness, 1. Goal, 2. Layer Model, 3. Naming & Export Conventions, 4. Coding Standards, 5. Testing Standards, 6. Current Features, 6. Directory Structure (+11 more)

### Community 606 - "Community 606"
Cohesion: 0.23
Nodes (12): AI Collaboration, Architektur, Audio-Pipeline (nach Anschlag-Erkennung), Chord-Template-Matching, chordExerciseEssentia – Akkord-Übung mit Essentia.js HPCP-Erkennung, chordExerciseEssentia – Akkord-Übung mit Essentia.js HPCP-Erkennung, code:block1 (chordExerciseEssentia/), code:block2 (chordExerciseEssentia.js) (+4 more)

### Community 607 - "Community 607"
Cohesion: 0.15
Nodes (12): beamSize, candidatesPerRound, fixturesDir, globalResetInterval, minScoreImprovement, outputDir, rounds, seed (+4 more)

### Community 608 - "Community 608"
Cohesion: 0.1
Nodes (21): code:bash (mkdir -p graphify-out), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash (# Detect the correct Python interpreter (handles pipx, venv,), code:bash ($(cat .graphify_python) -c ") (+13 more)
...
Cohesion: 0.13
Nodes (13): Analyse-Statistik, Architektur, code:json ({), code:block2 (node scripts/import-onset-zip.mjs <path-to-zip> [--force] [-), Dateien, Onset Tagger, Onsets einsortieren, Playback (+5 more)

### Community 611 - "Community 611"
Cohesion: 0.22
Nodes (12): Aktionen, Auswahl-Aktionen (sichtbar wenn ≥1 Checkbox aktiv), Bulk-Aktionen (sichtbar wenn Aufnahmen vorhanden), Dateien, Navigation, Quellen, recordingsOverview — Aufnahmen-Übersicht, recordingsOverview — Aufnahmen-Übersicht (+4 more)

### Community 612 - "Community 612"
Cohesion: 0.38
Nodes (10): analyzeIntervalMs, cooldownOverrideFactor, cooldownOverrideMinBandRatio, cooldownOverrideMinFlux, onsetFrameSize, relativeFluxFactor, relativeReattackFactor, relativeReattackMinDelta (+2 more)

### Community 613 - "Community 613"
Cohesion: 0.3
Nodes (10): beamSize, candidatesPerRound, fixturesDir, globalResetInterval, outputDir, rounds, seed, stagnationProbeCount (+2 more)

### Community 614 - "Community 614"
Cohesion: 0.48
Nodes (4): best, evaluated, mode, round
...
Cohesion: 0.17
Nodes (11): beamSize, candidatesPerRound, fixturesDir, globalResetInterval, minScoreImprovement, outputDir, rounds, seed (+3 more)
...
Cohesion: 0.17
Nodes (10): 1) Projektüberblick, 2) Code- und Architekturstatus, 3) Lokale Workflow-Hinweise, Codex – Ist-Zustand GuitarTools, 1) Projektüberblick, 2) Code- und Architekturstatus, 3) Dokumentations- und Agentenstatus, 3) Lokale Workflow-Hinweise (+2 more)
...
Cohesion: 0.28
Nodes (16): checkClipping(), checkNoOnset(), checkSilenceRatio(), checkTooQuiet(), checkTooShort(), rms(), runQualityGates(), clipCount (+8 more)

### Community 642 - "Community 642"
Cohesion: 0.44
Nodes (10): build_precommit_title(), bump_version(), extract_current_version(), extract_numeric_version_from_file(), format_version_from_counter(), is_staged(), main(), normalize_version_counter() (+2 more)
...
Cohesion: 0.14
Nodes (14): params, colsample_bytree, gamma, learning_rate, lookahead_frames, max_delta_step, max_depth, min_child_weight (+6 more)
...
Cohesion: 0.18
Nodes (30): bestTrainingMatch(), buildCatalog(), buildEntry(), catalog, countExpectedOnsets(), displayBaseName(), fallbackMetrics(), findLooseJsonForWav() (+22 more)
...
Cohesion: 0.4
Nodes (25): _, a, ae, B(), c, d(), declareVariables(), ee() (+17 more)
...
Cohesion: 0.17
Nodes (11): confusion_matrix, f1, pr_auc, precision, recall, roc_auc, test_negatives, test_positives (+3 more)
...
Cohesion: 0.08
Nodes (10): Accidental, accidentals, bars, container, Formatter, Renderer, Stave, StaveNote (+2 more)
...
Cohesion: 0.36
Nodes (8): expectedFinger1, expectedFinger2, expectedFinger4, getFretX(), getLabeledMarkerPosition(), getMutedCrossMidpoints(), getOpenMarkers(), getStringRowY()

### Community 687 - "Community 687"
Cohesion: 0.2
Nodes (7): detectedMs, __dirname, hits, MEDIUM_JSON, MEDIUM_WAV, stratBtn, tagged

### Community 688 - "Community 688"
Cohesion: 0.18
Nodes (9): Architecture Refactoring Plan, Fortschritt, Phase 1 – Quick Wins (kein Refaktorierungsrisiko), Phase 2 – Dokumentation & Sicherheit, Phase 3 – Controller-Tests, Phase 4 – Refaktorierung: chordRecorder.js (780 Z.), Phase 5 – Refaktorierung: essentiaChordLogic.js (997 Z.), Phase 6 – Refaktorierung: sheetMusicReading.js (1081 Z.) (+1 more)
...
Cohesion: 0.2
Nodes (9): Best By Strategy, Best Candidates, Best Fixture Counts, guitar-onset-sweep-standard, r001-guitar-onset-sweep-standard-0001-288f6a9c, r001-guitar-onset-sweep-standard-0002-7a9ff1f5, r001-guitar-onset-sweep-standard-0003-7b6f5811, r001-guitar-onset-sweep-standard-0004-bf1629f2 (+1 more)
...
Cohesion: 0.2
Nodes (9): bpm, category, description, notes, notesPerBeat, onsetsMs, recordedAt, tempoBpm (+1 more)
...
Cohesion: 0.36
Nodes (8): buildTunerDom(), chromatic, createMockAudioContext(), initTunerSVG, MockAudioContext(), standard, tool, updateTunerDisplay

### Community 716 - "Community 716"
Cohesion: 0.49
Nodes (8): collectJsFiles(), collectOversizedFiles(), findForbiddenImports(), getRelativeImports(), repoRoot, resolveImport(), toRepoRelative(), violations
...
Cohesion: 0.2
Nodes (7): code:bash (npm run onsetsweep -- --spec plans/sheet_music_onset_repair/), code:bash (./runsweep.ps1), code:bash (npm run onsetsweep -- --help), code:bash (npm run onsetsweep -- --spec plans/sheet_music_onset_repair/), code:bash (npm run onsetsweep -- --spec plans/sheet_music_onset_repair/), code:bash (npm run onsetsweep -- --spec plans/sheet_music_onset_repair/), Onset Sweep Usage
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: browserType.launch: Target page, context or browser h), code:yaml (- generic [active] [ref=e1]:), code:ts (23  |), Error details, Instructions, Page snapshot, Test info, Test source

### Community 807 - "Community 807"
Cohesion: 0.22
Nodes (8): code:block1 (Error: browserType.launch: Target page, context or browser h), code:yaml (- generic [active] [ref=e1]:), code:ts (55  |     await page.locator('#input-wav-file').setInputFile), Error details, Instructions, Page snapshot, Test info, Test source

### Community 808 - "Community 808"
Cohesion: 0.22
Nodes (8): code:block1 (Error: browserType.launch: Target page, context or browser h), code:yaml (- generic [ref=e2]:), code:ts (25  |), Error details, Instructions, Page snapshot, Test info, Test source

### Community 809 - "Community 809"
Cohesion: 0.22
Nodes (8): code:block1 (Error: browserType.launch: Target page, context or browser h), code:yaml (- generic [ref=e2]:), code:ts (1   | import { test, expect } from '@playwright/test';), Error details, Instructions, Page snapshot, Test info, Test source

### Community 810 - "Community 810"
Cohesion: 0.22
Nodes (8): code:block1 (Error: browserType.launch: Target page, context or browser h), code:yaml (- generic [ref=e2]:), code:ts (36  |     await page.locator('#tagger-wav-input').setInputFi), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.47
Nodes (5): bumpVersion(), formatVersionFromCounter(), main(), normalizeVersionCounter(), scriptPath

### Community 820 - "Community 820"
Cohesion: 0.18
Nodes (29): clearLastRecording(), dateValue(), deleteSheetMusicTake(), hasSidecar(), hasWav(), loadLastRecording(), loadLatestSheetMusicTake(), loadSheetMusicTake() (+21 more)

### Community 821 - "Community 821"
Cohesion: 0.39
Nodes (7): buildDom(), classifyFrame, createMockAudioContext(), feature, MockAudioContext(), renderNoteOnStaff, renderNotePositionsTab
...
Cohesion: 0.13
Nodes (21): computed, __dirname, firstChartWrap, firstMarker, firstPlayhead, firstSvg, flyout, input (+13 more)
...
Cohesion: 0.25
Nodes (8): score, extremeOverMultiplier, extremeOverPenalty, extremeUnderMultiplier, extremeUnderPenalty, guardrailOverMultiplier, overPenalty, underPenalty
...
Cohesion: 0.43
Nodes (6): bootstrap, html, mountPatternPages, pageDirs, pagesRoot, repoRoot

### Community 898 - "Community 898"
Cohesion: 0.48
Nodes (5): __dirname, emptyStrumAudioPath, feedback, observer, pushCurrentText()

### Community 899 - "Community 899"
Cohesion: 0.48
Nodes (5): aSus2AudioPath, __dirname, feedback, observer, pushCurrentText()

### Community 900 - "Community 900"
Cohesion: 0.48
Nodes (5): BARS, __dirname, FAST_WAV, note(), setup()

### Community 901 - "Community 901"
Cohesion: 0.48
Nodes (5): __dirname, eMollTwoFingerRegressionAudioPath, feedback, observer, pushCurrentText()
...
Cohesion: 0.29
Nodes (6): id, options, analyzeIntervalMs, round, score, strategyKey
...
Cohesion: 0.29
Nodes (6): Current Best By Strategy, guitar-onset, guitar-onset-broadband-or, guitar-onset-legacy-bandpass, guitar-onset-sweep-standard, Sheet Onset Sweep
...
Cohesion: 0.11
Nodes (20): calcBeatX(), PlaybackBar, createEndlessHelpers(), accidentalFromVfKey(), appendRow(), _renderNotation(), renderScore(), renderTab() (+12 more)
...
Cohesion: 0.53
Nodes (4): D3_WAV, __dirname, greenNotes, note()
...
Cohesion: 0.33
Nodes (7): blob, checkbox, req, sidecar, tx, wav, wavBytes
...
Cohesion: 0.17
Nodes (14): buildCollectionZipMock, buildRecordingZipMock, data, downloadBlobMock, enc, eocd, extracted, files (+6 more)
...
Cohesion: 0.33
Nodes (5): id, options, round, score, strategyKey
...
Cohesion: 0.48
Nodes (5): fixtureCount, fixtures, generatedAt, generator, schemaVersion

### Community 1500 - "Community 1500"
Cohesion: 0.33
Nodes (5): description, notes, notesPerBeat, onsetsMs, tempoBpm
...
Cohesion: 0.53
Nodes (4): mockScripts(), originalError, p, wasmInjections

### Community 1516 - "Community 1516"
Cohesion: 0.6
Nodes (3): feedback, observer, pushCurrentText()
...
Cohesion: 0.17
Nodes (14): calcFirstBarWidth(), calcScrollTarget(), CHROMATIC_SHARP, EndlessBarGenerator, generateBars(), getFilteredNotes(), getMajorScalePitchClasses(), getTimeSignatureConfig() (+6 more)

### Community 1519 - "Community 1519"
Cohesion: 0.6
Nodes (3): __awaiter(), Essentia(), __generator()

### Community 1520 - "Community 1520"
Cohesion: 0.33
Nodes (4): Context, GitHub Copilot Instructions - GuitarTools, Context, GitHub Copilot Instructions - GuitarTools
...
Cohesion: 0.15
Nodes (27): CHROMATIC_NOTES, drawRandom(), getNoteAtPosition(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS, CHROMATIC_NOTES, getAvailableNotes() (+19 more)
...
Cohesion: 0.13
Nodes (13): 1. ZIPs prüfen, 2. ZIPs importieren, 3. Chord-Katalog aktualisieren, 4. Chord-Tests ausführen, 5. Ergebnis berichten, code:bash (ls tests/fixtures/drop/*.zip 2>/dev/null || echo "Keine ZIPs), code:bash (node scripts/import-drop-fixtures.mjs), code:bash (npm run fixtures:chords:introduce) (+5 more)
...
Cohesion: 0.17
Nodes (11): 1. ZIPs prüfen, 2. ZIPs importieren, 3. Chord-Katalog aktualisieren, 4. Chord-Tests ausführen, 5. Ergebnis berichten, code:bash (ls tests/fixtures/drop/*.zip 2>/dev/null || echo "Keine ZIPs), code:bash (node scripts/import-drop-fixtures.mjs), code:bash (npm run fixtures:chords:introduce) (+3 more)

### Community 1662 - "Community 1662"
Cohesion: 0.11
Nodes (18): f_beta, mode, precision, recall, threshold, threshold_selection, configured_threshold, hyperparameter_tuning (+10 more)
...
Cohesion: 0.21
Nodes (10): code:bash (npm run test:unit), code:bash (npm run test:audio), code:bash (~/.codex/skills/sync/scripts/git-sync.sh \), Commit, Pull, Push, Entscheidungsbaum vor dem Start, Langsame Tests (nur wenn Audio-Fixtures betroffen oder explizit gewünscht), Regeln, Repo-Besonderheiten (+2 more)
...
Cohesion: 0.17
Nodes (10): Abschlussantwort, Arbeitsablauf, Architektur, DRY, KISS, YAGNI, Implement Task, Programmierprinzipien, SOLID, Startregel (+2 more)
...
Cohesion: 0.15
Nodes (20): createAkkordTrainerFeature(), createChordRecorderUI(), chordStringToFretboardIndex(), fretboardIndexToChordString(), clampWeight(), createSrsStore(), getWeight(), getWeights() (+12 more)
...
Cohesion: 0.18
Nodes (9): Abschlussantwort, Arbeitsablauf, Befehle, Bewertungsheuristik, Cleanup Task, code:bash (mkdir -p plans/old), code:markdown (# Archiv: <Planname> - <Abschnitt>), Grundregel (+1 more)
...
Cohesion: 0.17
Nodes (6): analyser, beatDots, chordName, fakeStream, fakeTrack, progressionDisplay
...
Cohesion: 0.21
Nodes (17): createChordRecorderTool(), addEventListener(), audioSession, cards, close, constructor(), createMockStorageService(), firstChord (+9 more)
...
Cohesion: 0.2
Nodes (8): code:bash (find tests/fixtures/dropsequence tests/fixtures/sequencedrop), code:bash (python3 .codex/skills/import-sequence-fixtures/scripts/impor), code:bash (npm run sheetfingerprint), Import Sequence Fixtures, Manifest Rules, Options, Overview, Workflow

### Community 1713 - "Community 1713"
Cohesion: 0.22
Nodes (7): code:bash (npm run fixtures:chords:introduce), code:bash (npx vitest run tests/unit/priority0ChordFixtureCoverage.test), Hinweise, Introduce Chord Fixture, Regeln, Workflow, Zweck

### Community 1714 - "Community 1714"
Cohesion: 0.34
Nodes (10): collectBrowserEnvironment(), parseAndroidModel(), parseAndroidVersion(), parseBrowser(), parseIOSVersion(), parseMacVersion(), parseOS(), parseWindowsVersion() (+2 more)

### Community 1715 - "Community 1715"
Cohesion: 0.15
Nodes (5): feature, root, createMetronomeFeature(), MetronomeSVG, metro
...
Cohesion: 0.26
Nodes (10): detectOnsetsOfflineXGBoost, expected, legacyOptions, loadDefaultXGBoostOnsetModel, mockModel, pseudoNoise(), result, samples (+2 more)
...
Cohesion: 0.16
Nodes (22): GERMAN_TO_CHROMA, getExpectedNoteClasses(), matchDetectedNotes(), parseChordName(), TYPE_INTERVALS, buildBassNeighborScores(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS (+14 more)
...
Cohesion: 0.16
Nodes (19): matchPureJsHpcpToChord(), extractHpcpAnalysisFromWav(), ALL_CHORD_NAMES, analysisCache, bassSupportCache, CHORD_FIXTURES_DIR, __dirname, getBassSupport() (+11 more)
...
Cohesion: 0.39
Nodes (7): createMockStorage(), entry, payload, serialized, sessionStorage, storage, store
...
Cohesion: 0.29
Nodes (10): createTonFinderFeature(), evaluateRound(), getAllPositions(), getNotePool(), NATURAL_NOTES, positionKey(), correctPositions, pool (+2 more)

### Community 1752 - "Community 1752"
Cohesion: 0.22
Nodes (13): createRecorder(), encodeWav(), getSupportedMimeType(), trimSilence(), ch, ch0, ch1, makeSignal() (+5 more)
...
Cohesion: 0.15
Nodes (12): 1. Sheet-Music + Note Fingerprint ausführen, 2. Optional: Nur Sheet-Music-Sequenz-Fingerprint, 3. Optional: Note-Fingerprint isoliert, 4. Goldens aktualisieren (nur wenn neue Fixtures hinzugefügt wurden), Ausgabe interpretieren, code:bash (npm run sfp), code:bash (npm run sheetfingerprint), code:bash (npm run notefingerprint) (+4 more)

### Community 1755 - "Community 1755"
Cohesion: 0.23
Nodes (14): a, b, bars, batch1, batch2, flat, gen, lastNote (+6 more)
...
Cohesion: 0.24
Nodes (4): createNotePlayingExerciseFeature(), MockAudioContext, skipBtn, targetNoteEl

### Community 1765 - "Community 1765"
Cohesion: 0.09
Nodes (22): result, t1, t2, t5, b1, b2, bars, gen (+14 more)
...
Cohesion: 0.4
Nodes (4): description, notes, notesPerBeat, tempoBpm
...
Cohesion: 0.6
Nodes (3): firstCard, firstFretboard, svgInsideFretboard

### Community 1777 - "Community 1777"
Cohesion: 0.6
Nodes (3): hint1, skipBtn, svg

### Community 1779 - "Community 1779"
Cohesion: 0.5
Nodes (3): Current Best By Strategy, guitar-onset-sweep-standard, Sheet Onset Sweep
...
Cohesion: 0.36
Nodes (8): ALL_CHORD_NAMES, ALL_TEMPLATES, __dirname, evaluateStrictMatrix(), FROZEN_FIXTURES, POSITIVE_FROZEN_FIXTURES, rows, STRICT_MATRIX_CASES

### Community 1897 - "Community 1897"
Cohesion: 0.27
Nodes (12): averageHpcps(), ALL_CHORD_NAMES, ALL_TEMPLATES, __dirname, NON_STRICT_MATRIX_CASES, POSITIVE_PREPARED_FIXTURES, PREPARED_FIXTURES, result (+4 more)
...
Cohesion: 0.6
Nodes (3): has_non_markdown_changes(), list_changed_files(), usage()
...
Cohesion: 0.5
Nodes (3): permissions, allow, $version

### Community 1915 - "Community 1915"
Cohesion: 0.15
Nodes (12): 1. Haupt-Fingerprint, 2. Nur Sheet-Music-Sequenz, 3. Nur Note-Fingerprint, 4. Goldens aktualisieren (nur bei neuen Fixtures), code:bash (npm run sfp), code:bash (npm run sheetfingerprint), code:bash (npm run notefingerprint), code:bash (npm run notefingerprint:goldens) (+4 more)
...
Cohesion: 0.17
Nodes (11): anyFret, feedbackText, fertigBtn, fretboard, label, pointsEl, selectedMarkers, slider (+3 more)
...
Cohesion: 0.27
Nodes (4): print_kv(), print_metrics_summary(), print_section(), resolve_python()
...
Cohesion: 0.32
Nodes (3): GtExerciseHeader, backLink, header
...
Cohesion: 0.18
Nodes (11): fixtureOverrides, open-strings/fast.wav, sheet-music-reading/4-4_40bpm_EGADB_9low6.wav, maxOnsets, minOnsets, role, weight, maxOnsets (+3 more)
...
Cohesion: 0.33
Nodes (9): detectPeaksFromSpectrum(), getChordNotes(), identifyNotesFromPeaks(), midiToNote(), OPEN_STRING_MIDI, detected, notes, peaks (+1 more)
...
Cohesion: 0.18
Nodes (10): 1. LOC-Audit (File Size Limits), 2. Layer-Verletzungen prüfen, 3. Ungekoppelte Module identifizieren, 4. Architektur-Report erstellen, 5. Maßnahmen vorschlagen, Aufgaben, code:bash (wc -l js/games/**/*.js js/tools/**/*.js | sort -rn | head -2), code:bash (grep -rn "document\.\|innerHTML\|createElement\|querySelecto) (+2 more)
...
Cohesion: 0.06
Nodes (52): detectNoteFromSamples(), getAudioFixtures(), installEssentiaDetectionHarness(), assertSequenceFixture(), deduplicateConsecutive(), __dirname, __filename, getSequenceFixture() (+44 more)

### Community 1983 - "Community 1983"
Cohesion: 0.25
Nodes (5): { analyzeAudioMock }, flyout, taggedOnsets, text, ui

### Community 1984 - "Community 1984"
Cohesion: 0.38
Nodes (8): GLOBAL_DEBUG_DEFAULTS, clonePayload(), createBasePageContext(), createGlobalDebugStore(), loadPersistedState(), normalizeString(), resolvePageUrl(), toIsoTimestamp()

### Community 1985 - "Community 1985"
Cohesion: 0.24
Nodes (14): buildMetaInput(), buildMetaRow(), DEFAULT_SIDECAR_FIELDS, DROPDOWN_OPTIONS, NUMERIC_DROPDOWN_KEYS, readInputValue(), readMetaForm(), renderMetaForm() (+6 more)
...
Cohesion: 0.33
Nodes (5): entries, generatedAt, mediaRoots, metricsSource, schemaVersion
...
Cohesion: 0.18
Nodes (10): checkBtn, chordName, feedbackText, fret1, fretboard, openCircles, scoreTotal, selectedMarker (+2 more)

### Community 1994 - "Community 1994"
Cohesion: 0.18
Nodes (10): bpmLabel, bpmSlider, buttons, keySelect, label, newBarsBtn, scoreContainer, slider (+2 more)
...
Cohesion: 0.33
Nodes (8): computeTaggedOnsetMetrics(), DEFAULT_TAGGED_ONSET_METRIC_OPTIONS, normalizeOnsets(), normalizeTrainingName(), percentile(), resolveOnsetModelTrainingStatus(), safeDivide(), result

### Community 1999 - "Community 1999"
Cohesion: 0.18
Nodes (11): 5. Tools & Shortcuts, code:bash (uv tool install graphifyy), code:bash (pipx install graphifyy), code:bash (pip install --user graphifyy), code:bash (graphify codex install), code:bash (sudo apt-get update && sudo apt-get install -y libnspr4 libn), Graphify (Knowledge Graph), Playwright / Chromium System Dependencies (+3 more)

### Community 2000 - "Community 2000"
Cohesion: 0.19
Nodes (18): a4, bars, currentIndex, dMajorPitchClasses, flatNote, flatNotes, fret8Notes, noteIndex() (+10 more)

### Community 2001 - "Community 2001"
Cohesion: 0.6
Nodes (3): accidentalByClass, accidentalByDataName, svg
...
Cohesion: 0.2
Nodes (9): backBtn, countEl, downloadBtn, errorMsg, firstCard, firstVisible, heading, manageBtn (+1 more)

### Community 2013 - "Community 2013"
Cohesion: 0.2
Nodes (10): 1. Collaboration & Documentation, 2. Technical Standards & Architecture, 3. Workflow & Quality Assurance, 4. Developer Guides, Adding a New Game/Exercise, AI Agent Mandates - GuitarTools, graphify, graphify (+2 more)

### Community 2014 - "Community 2014"
Cohesion: 0.47
Nodes (7): filter, getFilteredChords(), initFilters(), renderGrid(), ROOT_ORDER, TYPE_ORDER, CHORD_META
...
Cohesion: 0.18
Nodes (11): 1. Collaboration & Documentation, 2. Technical Standards & Architecture, 3. Workflow & Quality Assurance, 4. Developer Guides, Adding a New Game/Exercise, AI Agent Mandates - GuitarTools, graphify, graphify (+3 more)

### Community 2017 - "Community 2017"
Cohesion: 0.25
Nodes (8): 6. Container Dependencies, code:block6 (/usr/local/bin/graphify → /opt/uv-tools/graphifyy/bin/graphi), CUDA / GPU Status, Global npm Packages, Graphify, JavaScript / Node.js (package.json devDependencies), Python (ML Training – `.venv/`), System Packages (Ubuntu 24.04)
...
Cohesion: 0.2
Nodes (9): code:block1 (Test timeout of 45000ms exceeded.), code:block2 (Error: locator.click: Test timeout of 45000ms exceeded.), code:yaml (- generic [ref=e2]:), code:ts (1  | import { test, expect } from '@playwright/test';), Error details, Instructions, Page snapshot, Test info (+1 more)

### Community 2026 - "Community 2026"
Cohesion: 0.22
Nodes (8): buttons, firstBtn, fretboard, label, noteButtons, slider, svg, toggles
...
Cohesion: 0.19
Nodes (15): __dirname, installNodeOrt(), loadNodeXGBoostModelForStrategy(), loadTrainedOnsetModelStrategiesForNode(), makeProductionStrategy(), makeRegistryStrategy(), modelCache, ortBundlePath (+7 more)
...
Cohesion: 0.17
Nodes (13): args, baseNameForZip(), changed, dryRun, normalizeSidecar(), REPO_ROOT, repoPath(), results (+5 more)
...
Cohesion: 0.4
Nodes (5): code:bash (uv tool install graphifyy), code:bash (pipx install graphifyy), code:bash (pip install --user graphifyy), code:bash (graphify codex install), System Setup (einmalig pro Maschine)
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: expect(locator).toHaveCount(expected) failed), code:yaml (- generic [active] [ref=e1]:), code:ts (1   | import { test, expect } from '@playwright/test';), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.22
Nodes (8): code:block1 (Error: Expected at least one VexFlow accidental element in t), code:yaml (- generic [ref=e2]:), code:ts (1  | import { test, expect } from '@playwright/test';), Error details, Instructions, Page snapshot, Test info, Test source
...
Cohesion: 0.25
Nodes (7): alleBtn, container, diagrams, filterA, filterDur, firstDiagram, svg
...
Cohesion: 0.25
Nodes (7): backBtn, cards, exerciseHeader, firstCard, fretboard, PAGES, toggles

### Community 2075 - "Community 2075"
Cohesion: 0.29
Nodes (6): Abhängigkeiten (erlaubt), Abhängigkeiten (verboten), code:block1 (js/domain/), js/domain — Domain Logic Layer, Konventionen, Struktur
...
Cohesion: 0.29
Nodes (6): Audio & Erkennung, Ideen & Feature-Wishlist, Spielerfahrung / Übungen, Technisches / Infrastruktur, Tools, UI / UX
...
Cohesion: 0.4
Nodes (4): js/shared/audio — Shared Audio Modules, Konventionen, Modulübersicht, Wichtige Abhängigkeiten
...
Cohesion: 0.43
Nodes (6): buildZip(), crc32(), CRC_TABLE, downloadBlob(), writeU16(), writeU32()
...
## Knowledge Gaps
- **18456 isolated node(s):** `test`, `test:unit`, `test:precommit`, `test:audio:goldens`, `test:sync` (+18451 more)
...
- **Why does `x` connect `Community 419` to `Community 11`, `Community 1310`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `q` connect `Community 3` to `Community 660`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 16` to `Community 387`, `Community 10`, `Community 1752`, `Community 344`, `Community 346`, `Community 287`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `test`, `test:unit`, `test:precommit` to the rest of the system?**
  _18482 weakly-connected nodes found - possible documentation gaps or missing edges._

...
## Corpus Check
- 273 files · ~166,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2297 nodes · 3525 edges · 170 communities (156 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32da4ae3`
...
1. `readWavFile()` - 30 edges
2. `assert()` - 23 edges
3. `averageHpcps()` - 22 edges
4. `throwBindingError()` - 21 edges
5. `getRecommendedFftSize()` - 20 edges
6. `matchChordPath()` - 19 edges
7. `buildChordTemplates()` - 18 edges
8. `classifyFrame()` - 17 edges
9. `createMatchState()` - 16 edges
10. `readLatin1String()` - 16 edges
...
Cohesion: 0.04
Nodes (20): alignUp(), doCallback(), done(), _emscripten_get_heap_size(), emscripten_realloc_buffer(), _emscripten_resize_heap(), _environ_get(), _environ_sizes_get() (+12 more)
...
Cohesion: 0.08
Nodes (25): feature, root, feature, root, feature, root, createAkkordTrainerFeature(), createAkkordUebersichtFeature() (+17 more)
...
Cohesion: 0.13
Nodes (18): consumeOnsetGate(), createOnsetGateState(), isOnsetGateOpen(), updateOnsetGate(), replay, res, result, state (+10 more)
...
Cohesion: 0.11
Nodes (14): root, tool, createChordRecorderTool(), GUITAR_SIZES, GUITAR_STRINGS, PRE_COUNTDOWN, ROOT_ORDER, STRUM_MODI (+6 more)
...
Cohesion: 0.22
Nodes (17): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), extractBassSupportMapFromWav(), buildFrequencyFrames() (+9 more)
...
Cohesion: 0.16
Nodes (19): addRecording(), buildFileName(), buildSidecarJson(), clearRecordings(), dbClear(), dbDelete(), dbGetAll(), dbPut() (+11 more)
...
Cohesion: 0.11
Nodes (16): after, correct, earlyWindow, fftSize, full, minSamples, { nextState, event }, pitchHz() (+8 more)

### Community 37 - "Community 37"
Cohesion: 0.18
Nodes (14): collectWavFiles(), discoverSheetMusicSequenceFixtures(), evaluateFixture(), evaluateSheetMusicSequenceFingerprint(), formatPercent(), formatSheetMusicSequenceFingerprintReport(), normalizeFrameForSheetMusicReading(), runSheetMusicSequenceSimulation() (+6 more)
...
Cohesion: 0.12
Nodes (12): btnUpdate, debugStore, initSettings(), menuView, forceAppReload(), getSheetMusicRecognitionStrategies(), entry, payload (+4 more)
...
Cohesion: 0.18
Nodes (13): computeActiveBandRatio(), computeBroadbandFlux(), dbToLinear(), toLinearMagnitudes(), updateGuitarOnsetDetector(), computeFrameRms(), mixedSpectrum(), narrow (+5 more)
...
Cohesion: 0.14
Nodes (16): addFunctionWasm(), addRunDependency(), assert(), ccall(), convertJsFunctionToWasm(), createExportWrapper(), createWasm(), dynamicAlloc() (+8 more)
...
Cohesion: 0.28
Nodes (11): DEFAULTS, getSetting(), setSetting(), SETTING_KEYS, storageService, syncSheetMusicUI(), formatFretLabel(), syncFretSlider() (+3 more)
...
Cohesion: 0.13
Nodes (14): toChordKey(), c, config, m, meta, name, q, quality (+6 more)
...
Cohesion: 0.17
Nodes (7): bars, config, sigs, validKeys, firstBarW, w, getVoiceParams()
...
Cohesion: 0.38
Nodes (10): classifyFastNoteMatcherSheetMusicFrame(), classifySheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch(), resolveSheetMusicRecognitionStrategy(), SHEET_MUSIC_RECOGNITION_STRATEGIES (+2 more)
...
Cohesion: 0.33
Nodes (5): indices, lautstaerken, modi, result, techniken
...
## Knowledge Gaps
- **1030 isolated node(s):** `__dirname`, `url`, `OUT_DIR`, `fixtures`, `manifest` (+1025 more)
...
- **Why does `readWavFile()` connect `Community 26` to `Community 66`, `Community 67`, `Community 37`, `Community 103`, `Community 27`, `Community 77`, `Community 14`, `Community 13`, `Community 48`, `Community 20`, `Community 59`, `Community 28`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 100` to `Community 0`, `Community 39`, `Community 12`, `Community 45`, `Community 84`, `Community 23`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `buildChordTemplates()` connect `Community 78` to `Community 2`, `Community 66`, `Community 98`, `Community 68`, `Community 6`, `Community 9`, `Community 43`, `Community 12`, `Community 50`, `Community 51`, `Community 19`, `Community 25`, `Community 31`?**

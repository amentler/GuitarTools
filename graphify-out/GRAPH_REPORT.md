...
## Corpus Check
- 291 files · ~178,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2552 nodes · 3918 edges · 181 communities (168 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8bf64930`
...
Cohesion: 0.05
Nodes (35): feature, root, feature, root, feature, root, createAkkordTrainerFeature(), createAkkordUebersichtFeature() (+27 more)
...
Cohesion: 0.06
Nodes (41): createGuitarOnsetState(), getGuitarOnsetStrategies(), GUITAR_ONSET_STRATEGIES, GUITAR_ONSET_STRATEGY_KEYS, resolveGuitarOnsetStrategy(), __dirname, LIB_DIR, loadEssentiaForNode() (+33 more)
...
Cohesion: 0.09
Nodes (33): CHROMATIC_NOTES, drawRandom(), getNoteAtPosition(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS, CHROMATIC_NOTES, getAvailableNotes() (+25 more)
...
Cohesion: 0.09
Nodes (24): btnUpdate, debugStore, menuView, forceAppReload(), DEFAULTS, getSetting(), setSetting(), SETTING_KEYS (+16 more)
...
Cohesion: 0.1
Nodes (19): CATALOG_FILE, CHORD_FIXTURES_DIR, CHORD_TEMPLATES, collectOpenStrumNegativeFixtures(), __dirname, ensureDirectory(), GOLDEN_FILE, inferChordFolder() (+11 more)

### Community 20 - "Community 20"
Cohesion: 0.16
Nodes (20): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassSupportMapFromSamples(), extractBassSupportMapFromWav(), buildFrequencyFrames(), computeDbSpectrum() (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.16
Nodes (19): createEssentiaSheetMusicStrategy(), classifyFastNoteMatcherSheetMusicFrame(), classifySheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch(), resolveSheetMusicRecognitionStrategy() (+11 more)
...
Cohesion: 0.11
Nodes (17): extractBassScoreForChordFromWav(), CHORD_HPCP_FIXTURE_CASES, bassScore, bassSupportByChord, positiveWaveFixtures, ALL_CHORD_NAMES, analysisCache, bassSupportCache (+9 more)
...
Cohesion: 0.12
Nodes (15): createChordRecorderTool(), audioSession, cards, close, firstChord, manageButton, multi1, open (+7 more)
...
Cohesion: 0.17
Nodes (15): buildChordTemplates(), getChordNotes(), buildPeakFrames(), createEssentiaPage(), createStaticServer(), deepNormalize(), __dirname, essentiaLibDir (+7 more)
...
Cohesion: 0.12
Nodes (16): buildFileName(), getRecordingCount(), toChordKey(), c, config, m, meta, name (+8 more)
...
Cohesion: 0.23
Nodes (15): addRecording(), clearRecordings(), dbClear(), dbDelete(), dbGetAll(), dbPut(), downloadAllAsZip(), downloadBlob() (+7 more)
...
Cohesion: 0.24
Nodes (10): closeAudioSession(), createAudioSessionState(), openAudioSession(), stopMicrophoneStream(), closeNotePlayingAudioSession(), openNotePlayingAudioSession(), audioContext, session (+2 more)
...
Cohesion: 0.25
Nodes (10): createNotePlayingAudioSession(), createNotePlayingExerciseFeature(), resolveNotePlayingUI(), skipBtn, targetNoteEl, formatFretLabel(), syncFretSlider(), syncStringToggles() (+2 more)
...
Cohesion: 0.2
Nodes (10): closeAkkordfolgenAudioSession(), createAkkordfolgenAudioSession(), openAkkordfolgenAudioSession(), createAkkordfolgenTrainerFeature(), resolveAkkordfolgenUI(), setAkkordfolgenFeedback(), showAkkordfolgenActive(), showAkkordfolgenSetup() (+2 more)
...
Cohesion: 0.14
Nodes (9): GUITAR_SIZES, GUITAR_STRINGS, PRE_COUNTDOWN, ROOT_ORDER, STRUM_MODI, TECHNIKEN, TYPE_ORDER, buildSidecarJson() (+1 more)
...
Cohesion: 0.26
Nodes (8): validateChord(), createChordRecorderUI(), getRandomChord(), LEVELS, chordStringToFretboardIndex(), fretboardIndexToChordString(), CHORD_CATEGORIES, CHORDS
...
Cohesion: 0.27
Nodes (11): buildBassNeighborScores(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS, evaluateBassSupportForChord(), findPeakLinearMagnitudeNearFrequency(), FUNDAMENTAL_HARMONICS, FUNDAMENTAL_WEIGHTS, midiToCandidate() (+3 more)
...
Cohesion: 0.5
Nodes (4): matchHpcpToChord(), collectPositiveFolderFixtures(), getFixtureAverageHpcp(), getMatchResult()
...
## Knowledge Gaps
- **1165 isolated node(s):** `__dirname`, `url`, `ANALYSIS_OPTION_KEYS`, `DETECTOR_OPTION_KEYS`, `OUT_DIR` (+1160 more)
...
- **Why does `requestMicrophoneStream()` connect `Community 84` to `Community 68`, `Community 8`, `Community 14`, `Community 87`, `Community 63`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `readWavFile()` connect `Community 20` to `Community 64`, `Community 2`, `Community 3`, `Community 73`, `Community 11`, `Community 45`, `Community 18`, `Community 52`, `Community 21`, `Community 86`, `Community 22`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `averageHpcps()` connect `Community 80` to `Community 35`, `Community 165`, `Community 7`, `Community 9`, `Community 106`, `Community 45`, `Community 46`, `Community 47`, `Community 14`, `Community 20`, `Community 54`, `Community 30`, `Community 31`?**

# Graph Report - GuitarToolsALT  (2026-05-11)

## Corpus Check
- 302 files · ~184,173 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2645 nodes · 4134 edges · 186 communities (174 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4fc2dd6b`
...
2. `getRecommendedFftSize()` - 25 edges
3. `assert()` - 23 edges
4. `averageHpcps()` - 22 edges
5. `throwBindingError()` - 21 edges
6. `main()` - 19 edges
7. `matchChordPath()` - 19 edges
8. `classifyFrame()` - 18 edges
9. `createMatchState()` - 18 edges
10. `buildChordTemplates()` - 18 edges
...
Cohesion: 0.07
Nodes (49): appendResult(), dueToStop(), evaluateCandidate(), loadAudioFixtures(), main(), makeCandidateId(), writeResultArtifacts(), ANALYSIS_OPTION_KEYS (+41 more)
...
Cohesion: 0.06
Nodes (37): appendRow, buildZip, closeAudioSession, container, destroy(), downloadBlob, feature, hide() (+29 more)
...
Cohesion: 0.14
Nodes (24): clampWeight(), createSrsStore(), getWeight(), getWeights(), loadWeights(), pickNextItem(), recordResult(), DEFAULTS (+16 more)
...
Cohesion: 0.14
Nodes (19): computeActiveBandRatio(), computeBroadbandFlux(), computeSpectralNoveltyBins(), dbToLinear(), normalizeGuitarOnsetOptions(), toLinearMagnitudes(), updateGuitarOnsetDetector(), computeFrameRms() (+11 more)
...
Cohesion: 0.13
Nodes (18): feature, root, computeDbSpectrum(), fftInPlace(), getEssentia(), resolveGuitarOnsetStrategy(), analyzeInputLevel(), classifySheetMusicFrame() (+10 more)
...
Cohesion: 0.14
Nodes (17): getSheetMusicRecognitionStrategies(), buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets(), discoverSheetMusicSequenceFixtures(), evaluateFixture(), evaluateSheetMusicSequenceFingerprint(), formatAlignmentIssueCase() (+9 more)

### Community 23 - "Community 23"
Cohesion: 0.16
Nodes (18): classifyFrame(), createMatchState(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize(), parsePitch(), updateMatchState(), yinMinPeriods() (+10 more)
...
Cohesion: 0.12
Nodes (15): __dirname, LIB_DIR, loadEssentiaForNode(), formatPercent(), formatSheetMusicSequenceFingerprintReport(), SHEET_FINGERPRINT_POSITIVE_FIXTURE_FILES, { configPath, options: onsetConfigOptions }, essentiaStrategy (+7 more)
...
Cohesion: 0.09
Nodes (21): Adding a New Game, AI Collaboration & Documentation, Ansatz 1: Gitarren-Aufnahmen (Note + Oktave), Ansatz 2: Synthetische Sinuswellen (Note + Oktave + ≤ 5 Cent Präzision), Architecture, CI & Testing, code:block1 (index.html          – Main menu / landing page), code:html (<gt-fretboard id="my-board" frets="7" interactive></gt-fretb) (+13 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (15): getGuitarOnsetStrategies(), GUITAR_ONSET_STRATEGIES, GUITAR_ONSET_STRATEGY_KEYS, btnUpdate, debugStore, menuView, forceAppReload(), setSetting() (+7 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (16): CHORD_HPCP_FIXTURE_CASES, buildPeakFrames(), createEssentiaPage(), createStaticServer(), deepNormalize(), __dirname, essentiaLibDir, fixtureDir (+8 more)
...
Cohesion: 0.23
Nodes (16): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), buildFrequencyFrames(), computeDbSpectrum() (+8 more)

### Community 37 - "Community 37"
Cohesion: 0.15
Nodes (14): buildBassNeighborScores(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS, evaluateBassSupportForChord(), findPeakLinearMagnitudeNearFrequency(), FUNDAMENTAL_HARMONICS, FUNDAMENTAL_WEIGHTS, midiToCandidate() (+6 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (17): adaptiveBuffer(), after, correct, earlyWindow, fftSize, full, minSamples, { nextState, event } (+9 more)
...
Cohesion: 0.4
Nodes (17): _analysisFrames, appendAxes(), appendOnsetMarkers(), appendXAxis(), appendYGrid(), createSection(), _crosshairLines, GUITAR_STRINGS (+9 more)
...
Cohesion: 0.16
Nodes (9): createGuitarOnsetState(), closeNotePlayingAudioSession(), createNotePlayingAudioSession(), openNotePlayingAudioSession(), createNotePlayingExerciseFeature(), resolveNotePlayingUI(), MockAudioContext, skipBtn (+1 more)
...
Cohesion: 0.12
Nodes (12): root, tool, createChordRecorderTool(), GUITAR_SIZES, GUITAR_STRINGS, PRE_COUNTDOWN, ROOT_ORDER, STRUM_MODI (+4 more)
...
Cohesion: 0.18
Nodes (17): addRecording(), buildFileName(), clearRecordings(), dbClear(), dbDelete(), dbGetAll(), dbPut(), downloadBlob() (+9 more)
...
Cohesion: 0.18
Nodes (14): buildChordTemplates(), evaluateEssentiaFingerprintConfusion(), formatEssentiaFingerprintReport(), formatPercent(), safeDivide(), summarizeRow(), toAverageHpcp(), __dirname (+6 more)
...
Cohesion: 0.12
Nodes (15): avgHpcp, bassBlockedFPs, bassCriticalTPs, bidirectionalPairs, __dirname, fpKeys, fpsBySource, fragile (+7 more)
...
Cohesion: 0.13
Nodes (14): buildSidecarJson(), c, config, m, meta, name, q, quality (+6 more)
...
Cohesion: 0.26
Nodes (10): getNoteAtPosition(), evaluateRound(), getAllPositions(), getNotePool(), NATURAL_NOTES, positionKey(), correctPositions, pool (+2 more)
...
Cohesion: 0.21
Nodes (12): __addDays(), __arraySum(), ___assert_fail(), __embind_register_std_string(), intArrayFromString(), __isLeapYear(), lengthBytesUTF8(), _strftime() (+4 more)
...
Cohesion: 0.18
Nodes (11): _atexit(), checkUnflushedContent(), ___cxa_atexit(), demangle(), demangleAll(), _exit(), exitRuntime(), jsStackTrace() (+3 more)
...
Cohesion: 0.18
Nodes (10): 1. Documentation & Plan Updates, 2. Technical Standards, 3. Workflow, Current Architecture (updated – Phase 1 Web Components), Current Modules, Gemini Mandates - GuitarTools, `<gt-fretboard>` Web Component (Phase 1), Guitar Tuner Detection Status (+2 more)
...
Cohesion: 0.22
Nodes (8): mixedSpectrum(), narrow, opts, reattack, result, sparseAttack, spectrum(), state

### Community 107 - "Community 107"
Cohesion: 0.31
Nodes (8): matchEssentiaFingerprintHpcpToChord(), __dirname, getDetectionResult(), getFixture(), getProbeResult(), PREPARED_FIXTURES, { result }, TEMPLATES

### Community 108 - "Community 108"
Cohesion: 0.33
Nodes (5): getEssentia(), getRandomChord(), LEVELS, CHORD_CATEGORIES, CHORDS
...
Cohesion: 0.4
Nodes (5): CHROMATIC_NOTES, drawRandom(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS
...
Cohesion: 0.7
Nodes (4): clearLastRecording(), loadLastRecording(), openDb(), saveLastRecording()
...
## Knowledge Gaps
- **1199 isolated node(s):** `__dirname`, `url`, `ANALYSIS_OPTION_KEYS`, `DETECTOR_OPTION_KEYS`, `OUT_DIR` (+1194 more)
...
- **Why does `readWavFile()` connect `Community 36` to `Community 33`, `Community 2`, `Community 69`, `Community 6`, `Community 8`, `Community 91`, `Community 77`, `Community 19`, `Community 22`, `Community 23`, `Community 26`, `Community 27`, `Community 61`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 87` to `Community 0`, `Community 73`, `Community 15`, `Community 51`, `Community 52`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `classifyFrame()` connect `Community 23` to `Community 38`, `Community 8`, `Community 45`, `Community 19`, `Community 52`, `Community 51`, `Community 86`, `Community 22`, `Community 26`, `Community 27`?**

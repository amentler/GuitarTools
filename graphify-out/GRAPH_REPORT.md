...
## Corpus Check
- 305 files · ~187,213 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2681 nodes · 4180 edges · 192 communities (182 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e72b6638`
...
## Communities (192 total, 10 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (33): abort(), ___assert_fail(), _atexit(), checkUnflushedContent(), ___cxa_atexit(), demangle(), demangleAll(), _exit() (+25 more)
...
Cohesion: 0.08
Nodes (32): getGuitarOnsetStrategies(), getSheetMusicRecognitionStrategies(), __dirname, LIB_DIR, loadEssentiaForNode(), buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets() (+24 more)
...
Cohesion: 0.07
Nodes (27): feature, root, feature, root, feature, root, createAkkordTrainerFeature(), createAkkordUebersichtFeature() (+19 more)
...
Cohesion: 0.15
Nodes (32): getEssentia(), PITCH_STRATEGY_LABELS, _analysisFrames, appendAxes(), appendOnsetMarkers(), appendXAxis(), appendYGrid(), _buildTooltipContent() (+24 more)
...
Cohesion: 0.1
Nodes (29): addRecording(), buildFileName(), buildSidecarJson(), clearRecordings(), dbClear(), dbDelete(), dbGetAll(), dbPut() (+21 more)
...
Cohesion: 0.12
Nodes (17): buildFrequencyFrames(), computeRms(), extractHpcpAnalysisFromSamples(), extractHpcpAnalysisFromWav(), fftInPlace(), installEssentiaDetectionHarness(), decodeWav(), readWavFile() (+9 more)
...
Cohesion: 0.13
Nodes (17): computeActiveBandRatio(), computeBroadbandFlux(), computeSpectralNoveltyBins(), dbToLinear(), DEFAULT_GUITAR_ONSET_OPTIONS, normalizeGuitarOnsetOptions(), toLinearMagnitudes(), updateGuitarOnsetDetector() (+9 more)
...
Cohesion: 0.23
Nodes (16): clampWeight(), createSrsStore(), getWeight(), loadWeights(), pickNextItem(), recordResult(), DEFAULTS, getSetting() (+8 more)
...
Cohesion: 0.18
Nodes (19): buildBassNeighborScores(), buildBassSupportByChord(), DEFAULT_HARMONIC_WEIGHTS, DEFAULT_HARMONICS, evaluateBassSupportForChord(), findPeakLinearMagnitudeNearFrequency(), FUNDAMENTAL_HARMONICS, FUNDAMENTAL_WEIGHTS (+11 more)

### Community 35 - "Community 35"
Cohesion: 0.18
Nodes (13): feature, root, createSheetMusicReadingFeature(), getSheetMusicStorage(), loadSheetMusicPrefs(), saveSheetMusicActive(), saveSheetMusicBpm(), saveSheetMusicEndless() (+5 more)
...
Cohesion: 0.16
Nodes (11): GERMAN_TO_CHROMA, getExpectedNoteClasses(), matchDetectedNotes(), parseChordName(), TYPE_INTERVALS, OPEN_STRING_MIDI, NOTE_NAMES, cDurChords (+3 more)
...
Cohesion: 0.17
Nodes (15): CHROMATIC_NOTES, drawRandom(), getNoteAtPosition(), getRandomPosition(), OPEN_STRING_NOTES, STRING_LABELS, evaluateRound(), getAllPositions() (+7 more)
...
Cohesion: 0.23
Nodes (13): noteToFrequency(), createEssentiaSheetMusicStrategy(), classifyFastNoteMatcherSheetMusicFrame(), classifySheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch() (+5 more)
...
Cohesion: 0.15
Nodes (11): GUITAR_ONSET_STRATEGIES, GUITAR_ONSET_STRATEGY_KEYS, SWEEP_STANDARD_GUITAR_ONSET_OPTIONS, freq, frequencyData, result, s, samples (+3 more)
...
Cohesion: 0.12
Nodes (11): btnUpdate, debugStore, menuView, forceAppReload(), setSetting(), entry, payload, serialized (+3 more)
...
Cohesion: 0.13
Nodes (10): result, t1, t2, t5, bars, config, sigs, validKeys (+2 more)
...
Cohesion: 0.3
Nodes (8): closeAudioSession(), createAudioSessionState(), openAudioSession(), stopMicrophoneStream(), audioContext, session, stream, track

### Community 80 - "Community 80"
Cohesion: 0.2
Nodes (10): createGuitarOnsetState(), feature, root, closeNotePlayingAudioSession(), createNotePlayingAudioSession(), openNotePlayingAudioSession(), createNotePlayingExerciseFeature(), resolveNotePlayingUI() (+2 more)
...
Cohesion: 0.28
Nodes (10): computeDbSpectrum(), fftInPlace(), resolveGuitarOnsetStrategy(), analyzeInputLevel(), classifySheetMusicFrame(), resolveSheetMusicRecognitionStrategy(), analyzeAudio(), collectFrameData() (+2 more)
...
Cohesion: 0.2
Nodes (8): getWeights(), counts, raw, result, s, storage, store, w
...
Cohesion: 0.31
Nodes (5): validateChord(), getEssentia(), getRandomChord(), LEVELS, CHORD_CATEGORIES
...
Cohesion: 0.5
Nodes (3): feature, root, createFretboardToneRecognitionFeature()

### Community 179 - "Community 179"
Cohesion: 0.5
Nodes (4): downloadAllAsZip(), downloadBlob(), downloadJson(), getAllRecordings()
...
## Knowledge Gaps
- **1218 isolated node(s):** `__dirname`, `url`, `ANALYSIS_OPTION_KEYS`, `DETECTOR_OPTION_KEYS`, `OUT_DIR` (+1213 more)
...
- **Why does `readWavFile()` connect `Community 18` to `Community 1`, `Community 2`, `Community 34`, `Community 75`, `Community 12`, `Community 77`, `Community 17`, `Community 21`, `Community 87`, `Community 26`, `Community 91`, `Community 28`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 105` to `Community 35`, `Community 73`, `Community 14`, `Community 80`, `Community 92`, `Community 94`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `classifyFrame()` connect `Community 12` to `Community 2`, `Community 35`, `Community 37`, `Community 76`, `Community 47`, `Community 80`, `Community 17`, `Community 21`, `Community 56`, `Community 26`, `Community 28`?**

...
## Corpus Check
- 612 files · ~933,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30694 nodes · 41450 edges · 2092 communities (2070 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 176 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `584bb0fb`
...
- `evaluateXGBoostOnsetModelReport()` --calls--> `progress`  [INFERRED]
  tests/helpers/sheetMusicSequenceFingerprint.js → scripts/sheet-and-note-fingerprint.mjs
...
- `createAudioAnalyseFeature()` --calls--> `createGlobalDebugStore()`  [INFERRED]
  js/tools/audioAnalyse/audioAnalyse.js → /workspace/GuitarTools/js/shared/debug/debugStore.js
- `renderNoteChart()` --calls--> `noteToFrequency()`  [INFERRED]
  js/tools/audioAnalyse/audioAnalyseSVG.js → /workspace/GuitarTools/js/domain/pitch/pitchCore.js

## Communities (2092 total, 22 thin omitted)
...
Cohesion: 0.06
Nodes (70): createEssentiaSheetMusicStrategy(), frameRms(), parsePitch(), classifyFrame(), createMatchState(), FFT_SIZE_OPTIONS, getMinSamplesFor(), getRecommendedFftSize() (+62 more)
...
Cohesion: 0.08
Nodes (29): feature, root, createAkkordfolgenTrainerFeature(), feature, root, feature, root, root (+21 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (82): createGuitarOnsetState(), buildWasmSandbox(), __dirname, LIB_DIR, loadEssentiaForNode(), collectWavs(), discoverNoteAudioFixtures(), inferPitchFromPath() (+74 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (80): createAudioTransport(), collectFrameData(), computeDbSpectrum(), fftInPlace(), getEssentia(), loadScript(), BROADBAND_OR_GUITAR_ONSET_OPTIONS, BROADBAND_OR_NORMALIZED_OPTIONS (+72 more)
...
Cohesion: 0.07
Nodes (47): GLOBAL_DEBUG_DEFAULTS, clonePayload(), createBasePageContext(), createGlobalDebugStore(), loadPersistedState(), normalizeString(), resolvePageUrl(), toIsoTimestamp() (+39 more)
...
Cohesion: 0.07
Nodes (54): closeAkkordfolgenAudioSession(), createAkkordfolgenAudioSession(), openAkkordfolgenAudioSession(), closeAudioSession(), createAudioSessionState(), openAudioSession(), DEFAULT_CONSTRAINTS, requestMicrophoneStream() (+46 more)
...
Cohesion: 0.11
Nodes (19): CHORD_FIXTURES_DIR, clampStart(), createAdvancingWait(), createFakeChordDetectionAnalyserFromWav(), __dirname, FakeChordDetectionAnalyser, assertSequenceFixture(), deduplicateConsecutive() (+11 more)

### Community 288 - "Community 288"
Cohesion: 0.17
Nodes (18): matchPureJsHpcpToChord(), evaluateChordRecognitionConfusion(), formatChordRecognitionJsfingerprintReport(), formatChordRecognitionMetricsReport(), formatPercent(), safeDivide(), summarizeRow(), toAverageHpcp() (+10 more)
...
Cohesion: 0.13
Nodes (42): DEFAULT_SIDECAR_FIELDS, DROPDOWN_OPTIONS, NUMERIC_DROPDOWN_KEYS, wireOnsetTaggerEvents(), closeLoadMenu(), wireLoadMenu(), addOnset(), addOnsetWithIndex() (+34 more)
...
Cohesion: 0.09
Nodes (42): validateChord(), getRandomChord(), LEVELS, getChordNotes(), A_SHAPE_OFFSETS, BASE_CHORDS, buildChordMeta(), buildCompleteChordCatalog() (+34 more)
...
Cohesion: 0.06
Nodes (96): discoverSequenceFixtureSources(), appendResult(), bestForStrategy(), compactResult(), DEFAULT_WORKER_COUNT, dispatchBatch(), dueToStop(), estimateAnalysisCost() (+88 more)
...
Cohesion: 0.08
Nodes (52): apply_app_peak_picking(), apply_negative_sampling(), build_eval_files(), compute_metrics(), concat_files(), evaluate_app_peak_picking(), export_onnx(), find_best_f1_threshold() (+44 more)
...
Cohesion: 0.14
Nodes (12): Architektur, code:json ({), code:block2 (node scripts/import-onset-zip.mjs <path-to-zip> [--force] [-), Dateien, Onset Tagger, Onsets einsortieren, Playback, Seite (+4 more)
...
Cohesion: 0.15
Nodes (20): collectFixtureFiles(), normalizeLookupPath(), normalizeRelativePath(), parseManifest(), readLooseSequencePair(), readSequenceZip(), resolveSequenceFixtureSource(), scoreFixtureLookupMatch() (+12 more)
...
Cohesion: 0.33
Nodes (6): fixtureOverrides, open-strings/slow.wav, maxOnsets, minOnsets, role, weight
...
Cohesion: 0.31
Nodes (9): feature, root, createAkkordUebersichtFeature(), filter, getFilteredChords(), initFilters(), renderGrid(), ROOT_ORDER (+1 more)
...
Cohesion: 0.14
Nodes (21): feature, root, createAkkordTrainerFeature(), chordStringToFretboardIndex(), fretboardIndexToChordString(), clampWeight(), createSrsStore(), getWeight() (+13 more)
...
Cohesion: 0.12
Nodes (3): GtAnalysisFlyout, GtBpmButtons, GtStringToggles
...
Cohesion: 0.06
Nodes (66): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), extractBassSupportMapFromWav(), buildFrequencyFrames() (+58 more)
...
Cohesion: 0.1
Nodes (41): createOnsetGateState(), resampleLinear(), loadSequenceFixtureAudio(), buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets(), countRmsOnsets(), createOnsetEvaluation() (+33 more)
...
Cohesion: 0.23
Nodes (12): getDurationMs(), getSortedChordNames(), GUITAR_SIZES, GUITAR_STRINGS, loadInventory(), PRE_COUNTDOWN, ROOT_ORDER, sleep() (+4 more)
...
Cohesion: 0.22
Nodes (9): 1. Collaboration & Documentation, 2. Technical Standards & Architecture, 3. Workflow & Quality Assurance, 4. Developer Guides, Adding a New Game/Exercise, AI Agent Mandates - GuitarTools, graphify, Pre-Commit Mandate (+1 more)
...
Cohesion: 0.22
Nodes (13): createFretboardToneRecognitionFeature(), resolveNotePlayingUI(), syncSheetMusicUI(), btn, buttons, formatFretLabel(), formatFretRangeLabel(), syncFretSlider() (+5 more)
...
Cohesion: 0.38
Nodes (5): feature, root, createOnsetTaggerFeature(), createOnsetTaggerAnalysisFlyout(), createOnsetTaggerXGBoostController()
...
## Knowledge Gaps
- **17946 isolated node(s):** `test`, `test:unit`, `test:precommit`, `test:audio:goldens`, `test:sync` (+17941 more)
...
- **What connects `test`, `test:unit`, `test:precommit` to the rest of the system?**
  _17967 weakly-connected nodes found - possible documentation gaps or missing edges._

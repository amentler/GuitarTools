...
## Corpus Check
- 330 files · ~206,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3024 nodes · 4632 edges · 208 communities (197 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce8c42b9`
...
## Communities (208 total, 11 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (68): createGuitarTunerFeature(), createAudioSessionState(), nextGuidedStepState(), startGuidedModeState(), stopGuidedModeState(), createAnalysisRuntime(), createGuidedState(), createTunerDisplayState() (+60 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (34): abort(), alignUp(), demangle(), demangleAll(), _emscripten_get_heap_size(), emscripten_realloc_buffer(), _emscripten_resize_heap(), _environ_get() (+26 more)
...
Cohesion: 0.06
Nodes (32): feature, root, feature, root, createAkkordUebersichtFeature(), feature, root, createAudioAnalyseFeature() (+24 more)
...
Cohesion: 0.08
Nodes (32): buildChordTemplates(), matchEssentiaFingerprintHpcpToChord(), getChordNotes(), evaluateEssentiaFingerprintConfusion(), formatEssentiaFingerprintReport(), formatPercent(), safeDivide(), summarizeRow() (+24 more)
...
Cohesion: 0.11
Nodes (23): getGuitarOnsetStrategies(), createOnsetGateState(), getSheetMusicRecognitionStrategies(), buildOnsetAcceptAlignment(), collectWavFiles(), countGuitarOnsets(), countRmsOnsets(), discoverSheetMusicSequenceFixtures() (+15 more)
...
Cohesion: 0.15
Nodes (21): computeActiveBandRatio(), computeActiveBandRatioLinear(), computeBroadbandFlux(), computeSpectralNoveltyBins(), createGuitarOnsetState(), dbToLinear(), normalizeGuitarOnsetOptions(), toLinearMagnitudes() (+13 more)
...
Cohesion: 0.25
Nodes (26): _analysisFrames, appendAxes(), appendOnsetMarkers(), appendXAxis(), appendYGrid(), _buildTooltipContent(), createSection(), _crosshairLines (+18 more)

### Community 22 - "Community 22"
Cohesion: 0.17
Nodes (22): buildBassSupportByChord(), CHORD_FIXTURES_DIR, __dirname, extractBassScoreForChordFromSamples(), extractBassScoreForChordFromWav(), extractBassSupportMapFromSamples(), extractBassSupportMapFromWav(), buildFrequencyFrames() (+14 more)
...
Cohesion: 0.11
Nodes (19): DEFAULT_GUITAR_ONSET_OPTIONS, ANALYSIS_OPTION_KEYS, assertPlainObject(), DETECTOR_OPTION_KEYS, loadSheetMusicOnsetConfigFromArgs(), normalizeConfig(), readConfigPath(), mixedSpectrum() (+11 more)
...
Cohesion: 0.14
Nodes (17): DEFAULTS, getSetting(), setSetting(), SETTING_KEYS, storageService, feature, root, createTonFinderFeature() (+9 more)
...
Cohesion: 0.2
Nodes (18): buildAudioAnalyseUrl(), buildDisplayName(), buildOnsetTaggerUrl(), formatDate(), formatFileSize(), sortByDate(), deleteChordRecording(), deleteRecordingBySource() (+10 more)
...
Cohesion: 0.18
Nodes (19): updateSheetMusicMatchState(), classifyFastNoteMatcherSheetMusicFrame(), classifySheetMusicFrame(), frameRms(), getSheetMusicTargetHarmonicScore(), harmonicAmplitude(), parsePitch(), resolveSheetMusicRecognitionStrategy() (+11 more)
...
Cohesion: 0.13
Nodes (13): __dirname, LIB_DIR, loadEssentiaForNode(), SHEET_FINGERPRINT_POSITIVE_FIXTURE_FILES, { configPath, options: onsetConfigOptions }, essentiaStrategy, onsetStrategies, strategies (+5 more)

### Community 47 - "Community 47"
Cohesion: 0.11
Nodes (15): consumeOnsetGate(), isOnsetGateOpen(), replay, res, result, state, sustained, accepted (+7 more)
...
Cohesion: 0.21
Nodes (14): createSheetMusicReadingFeature(), getSheetMusicStorage(), loadSheetMusicPrefs(), saveSheetMusicActive(), saveSheetMusicBpm(), saveSheetMusicEndless(), saveSheetMusicShowTab(), saveSheetMusicTimeSig() (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.17
Nodes (14): getEssentia(), PITCH_STRATEGY_LABELS, decodeWav(), getFrameAtFraction(), initCrosshair(), resetPlayhead(), updatePlayhead(), clearLastRecording() (+6 more)
...
Cohesion: 0.11
Nodes (17): buildFileName(), buildSidecarJson(), generateRandom5(), toChordKey(), c, config, m, meta (+9 more)

### Community 65 - "Community 65"
Cohesion: 0.18
Nodes (12): evaluateAnswer(), initGameState(), draws, pos, previous, result, settings, state (+4 more)

### Community 66 - "Community 66"
Cohesion: 0.17
Nodes (11): calcFirstBarWidth(), getTimeSignatureConfig(), NOTES, validateTimeSignature(), appendRow(), _renderNotation(), renderScore(), renderTab() (+3 more)
...
Cohesion: 0.24
Nodes (10): closeAudioSession(), createAudioSessionState(), openAudioSession(), stopMicrophoneStream(), closeAudioSession(), openAudioSession(), audioContext, session (+2 more)
...
Cohesion: 0.13
Nodes (16): __addDays(), __arraySum(), ___assert_fail(), _atexit(), checkUnflushedContent(), ___cxa_atexit(), _exit(), exitRuntime() (+8 more)
...
Cohesion: 0.32
Nodes (9): computeDbSpectrum(), fftInPlace(), resolveGuitarOnsetStrategy(), analyzeInputLevel(), classifySheetMusicFrame(), resolveSheetMusicRecognitionStrategy(), analyzeAudio(), collectFrameData() (+1 more)
...
Cohesion: 0.32
Nodes (7): __dirname, getDetectionResult(), getFixture(), getProbeResult(), PREPARED_FIXTURES, { result }, TEMPLATES
...
Cohesion: 0.5
Nodes (3): feature, root, createMetronomeFeature()

### Community 192 - "Community 192"
Cohesion: 0.5
Nodes (3): root, tool, createChordRecorderTool()
...
## Knowledge Gaps
- **1402 isolated node(s):** `__dirname`, `url`, `ANALYSIS_OPTION_KEYS`, `DETECTOR_OPTION_KEYS`, `OUT_DIR` (+1397 more)
...
- **Why does `readWavFile()` connect `Community 22` to `Community 32`, `Community 33`, `Community 2`, `Community 40`, `Community 42`, `Community 13`, `Community 78`, `Community 15`, `Community 47`, `Community 85`, `Community 25`, `Community 92`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `requestMicrophoneStream()` connect `Community 93` to `Community 0`, `Community 33`, `Community 99`, `Community 75`, `Community 17`, `Community 56`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `classifyFrame()` connect `Community 12` to `Community 32`, `Community 33`, `Community 40`, `Community 13`, `Community 15`, `Community 47`, `Community 52`, `Community 87`, `Community 56`, `Community 25`, `Community 58`?**

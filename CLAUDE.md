...
- **Do NOT edit `version.txt` manually.** The pre-commit hook (`scripts/auto-update-version.sh`) always regenerates and stages it automatically. Manual edits are overwritten. Also do NOT stage `version.txt` — the hook owns it.

...
const eMollTwoFingerRegressionAudioPath = path.resolve(__dirname, '../fixtures/chords/E-Moll/synth.wav');
...
test.use({
  launchOptions: {
    args: [
      ...
      `--use-file-for-fake-audio-capture=${eMollTwoFingerRegressionAudioPath}`,
    ],
  },
});

...
export const CHORD_META = {
  ...
  "E-Moll":   { rootNote: "E", chordType: "Moll" },
  "A-Moll":   { rootNote: "A", chordType: "Moll" },
  "E-Dur":    { rootNote: "E", chordType: "Dur"  },
  "A-Dur":    { rootNote: "A", chordType: "Dur"  },
  "D-Moll":   { rootNote: "D", chordType: "Moll" },
  "F-Dur":    { rootNote: "F", chordType: "Dur"  },
  "H-Dur":    { rootNote: "H", chordType: "Dur"  },
  "H-Moll":   { rootNote: "H", chordType: "Moll" },
  "C-Moll":   { rootNote: "C", chordType: "Moll" },
  "F-Moll":   { rootNote: "F", chordType: "Moll" },
  "G-Moll":   { rootNote: "G", chordType: "Moll" },
  "G7":       { rootNote: "G", chordType: "Dom7" },
  "C7":       { rootNote: "C", chordType: "Dom7" },
  "D7":       { rootNote: "D", chordType: "Dom7" },
  "A7":       { rootNote: "A", chordType: "Dom7" },
  "E7":       { rootNote: "E", chordType: "Dom7" },
  "F7":       { rootNote: "F", chordType: "Dom7" },
  "H7 (B7)":  { rootNote: "H", chordType: "Dom7" },
  "Cmaj7":    { rootNote: "C", chordType: "Maj7" },
  "Gmaj7":    { rootNote: "G", chordType: "Maj7" },
  "Dmaj7":    { rootNote: "D", chordType: "Maj7" },
  "Amaj7":    { rootNote: "A", chordType: "Maj7" },
  "Emaj7":    { rootNote: "E", chordType: "Maj7" },
  "Fmaj7":    { rootNote: "F", chordType: "Maj7" },
  "Hmaj7":    { rootNote: "H", chordType: "Maj7" },
  "Am7":      { rootNote: "A", chordType: "Min7" },
  "Dm7":      { rootNote: "D", chordType: "Min7" },
  "Em7":      { rootNote: "E", chordType: "Min7" },
  "Cm7":      { rootNote: "C", chordType: "Min7" },
  "Fm7":      { rootNote: "F", chordType: "Min7" },
  "Gm7":      { rootNote: "G", chordType: "Min7" },
  "Hm7":      { rootNote: "H", chordType: "Min7" },
  "Adim":     { rootNote: "A", chordType: "Dim"  },
  "Hdim":     { rootNote: "H", chordType: "Dim"  },
  "Cdim":     { rootNote: "C", chordType: "Dim"  },
  "Ddim":     { rootNote: "D", chordType: "Dim"  },
  "Edim":     { rootNote: "E", chordType: "Dim"  },
  "Fdim":     { rootNote: "F", chordType: "Dim"  },
  "Gdim":     { rootNote: "G", chordType: "Dim"  },
  "F-Dur (klein)": { rootNote: "F", chordType: "Dur" },
  "Asus2":    { rootNote: "A", chordType: "Sus"  },
  "Asus4":    { rootNote: "A", chordType: "Sus"  },
  "Dsus2":    { rootNote: "D", chordType: "Sus"  },
  "Dsus4":    { rootNote: "D", chordType: "Sus"  },
  "Esus2":    { rootNote: "E", chordType: "Sus"  },
  "Esus4":    { rootNote: "E", chordType: "Sus"  },
  "Csus2":    { rootNote: "C", chordType: "Sus"  },
  "Csus4":    { rootNote: "C", chordType: "Sus"  },
  "Fsus2":    { rootNote: "F", chordType: "Sus"  },
  "Fsus4":    { rootNote: "F", chordType: "Sus"  },
  "Gsus2":    { rootNote: "G", chordType: "Sus"  },
  "Gsus4":    { rootNote: "G", chordType: "Sus"  },
  "G7sus4":   { rootNote: "G", chordType: "Sus"  },
  "Hsus2":    { rootNote: "H", chordType: "Sus"  },
  "Hsus4":    { rootNote: "H", chordType: "Sus"  },
  "H7sus4":   { rootNote: "H", chordType: "Sus"  },
  "Cadd9":    { rootNote: "C", chordType: "Add"  },
  "Gadd9":    { rootNote: "G", chordType: "Add"  },
  "Eadd9":    { rootNote: "E", chordType: "Add"  },
  "Aadd9":    { rootNote: "A", chordType: "Add"  },

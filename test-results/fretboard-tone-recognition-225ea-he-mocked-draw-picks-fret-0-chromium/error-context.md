...
- Name: fretboard-tone-recognition.spec.js >> Fretboard Tone Recognition Exercise >> shows an open-string target marker left of the fretboard when the mocked draw picks fret 0
- Location: tests/e2e/fretboard-tone-recognition.spec.js:16:3
...
Locator:  locator('gt-fretboard circle[fill="none"][stroke="#ff6b35"]')
Expected: 1
Received: 0
Timeout:  30000ms
...
Call log:
  ...
  - waiting for locator('gt-fretboard circle[fill="none"][stroke="#ff6b35"]')
